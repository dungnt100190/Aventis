Feature: LoadPendenzenData
	Get list of Pendenzen base on item option of navbar menu

	Background:
	Given Url of Login page is http://localhost:4300
	And Url of Pendenzen page is http://localhost:4300/pendenzen
...
Scenario: Get Pendenzen data
	...
	And data of grid view Task should be
	| Fällig                  | Betreff          | Leistung | Fallträger            | Fallnummer | Person       | Ersteller                  | Empfänger                  | Status | Erfasst                 | Bearbeitung             | Erledigt | Antwort               |
	| 2020-01-10 00:00:00.000 | Task 20180817-01 | F        | Person test-1 (66759) | 66759      | Person-1, NT | NULL                       | test_admin_1 - Global, CMC | 1      | 2018-01-10 00:00:00.000 | NULL                    | NULL     | Task 20180817-1 text  |
	| 2018-05-10 00:00:00.000 | Task 20180817-02 | K        | Person test-1 (66759) | 66760      | Person 2     | NULL                       | test_admin_1 - Global, CMC | 1      | 2018-01-10 00:00:00.000 | NULL                    | NULL     | Task 20180817-2 text  |
	| 2018-10-10 00:00:00.000 | Task 20180817-03 | F        | Person test-2 (66760) | 66760      | Person-1, NT | NULL                       | test_admin_1 - Global, CMC | 2      | 2018-01-10 00:00:00.000 | 2018-04-10 00:00:00.000 | NULL     | Task 20180817-3 text  |
	| 2018-07-10 00:00:00.000 | Task 20180817-04 | K        | Person test-2 (66760) | 66759      | Person 2     | NULL                       | test_admin_1 - Global, CMC | 2      | 2018-01-10 00:00:00.000 | 2018-06-10 00:00:00.000 | NULL     | Task 20180817-4 text  |
	| 2018-10-10 00:00:00.000 | Task 20180817-08 | K        | Person test-2 (66760) | 66759      | Person-1, NT | test_admin_1 - Global, CMC | test_admin_1 - Global, CMC | 2      | 2018-01-10 00:00:00.000 | 2018-05-10 00:00:00.000 | NULL     | Task 20180817-8 text  |
	| 2018-11-10 00:00:00.000 | Task 20180817-09 | F        | Person test-2 (66760) | 66760      | Person-1, NT | NULL                       | test_admin_1 - Global, CMC | 1      | 2018-01-10 00:00:00.000 | NULL                    | NULL     | Task 20180817-9 text  |
	| 2018-12-10 00:00:00.000 | Task 20180817-10 | F        | Person test-2 (66760) | 66760      | Person 2     | NULL                       | test_admin_1 - Global, CMC | 1      | 2018-01-10 00:00:00.000 | NULL                    | NULL     | Task 20180817-10 text |

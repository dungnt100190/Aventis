...
Scenario: 01 Update Pendenzen
	...
	| id   | status | pendenzTyp | betreff            | beschreibung               | empfangerId | falltrager | leistung | PersonId | antwort                | fallig                  |
	| TSK1 | 1      | 4          | Update 20180817-01 | Update 20180817-1 autotest | USR2        | BPS1       | LEI3     | BPS2     | Update 20180817-1 text | 2019-01-10 00:00:00.000 |
	Then the call is successful
	And the return value of API CreateUpdateTask should be true
	And the record of the inputted info is updated into table XTask in database
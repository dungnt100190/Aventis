Feature: CreatePendenzen
	...
	| USR1   | 9                 | 9                | test_admin_3 | kR9Y+JkxEwo= | CMC       | Global   | cg        | 0        | 1           | 1               | 0                | 1          | 0             | 0          | 257000 |
	| USR2   | 9                 | 9                | test_admin_4 | kR9Y+JkxEwo= | CMC       | Soft     | cs        | 0        | 1           | 1               | 0                | 1          | 0             | 0          | 257000 |
...
Scenario: Create new Pendenzen
	Given CreatePendenzen client has LogonName is test_admin_3, PasswordHash is 123456 
	...
	| 1      | 2          | Insert 20180817-01 | Insert 20180817-1 autotest | test_admin_4 - Soft, CMC | test_admin_3 - Global, CMC | 65134      | Meier, Hans (65134)  | 98952    | F - Fallführung (21.04.2010 -) | afuchs - Fuchs, Andreas (Sozialdienst) | 65088    | Brunner, Renate    | Insert 20180817-1 text | 10.06.2019 00:00:00 | 

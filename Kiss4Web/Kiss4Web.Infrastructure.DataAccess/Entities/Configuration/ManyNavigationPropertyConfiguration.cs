...
namespace Kiss4Web.Infrastructure.DataAccess.Entities.Configuration
{
    ...
    {
        private readonly List<Action<CollectionNavigationBuilder<TEntityType, TTargetEntity>>> _actions = new List<Action<CollectionNavigationBuilder<TEntityType, TTargetEntity>>>();

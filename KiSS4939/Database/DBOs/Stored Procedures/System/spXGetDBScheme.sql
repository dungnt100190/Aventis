...
GO
/*===============================================================================================
  $Archive: /KiSS4/Database/DBOs/Stored Procedures/System/spXGetDBScheme.sql $
  $Author: Tabegglen $
  $Modtime: 28.04.10 15:31 $
  $Revision: 7 $
=================================================================================================
  Description
-------------------------------------------------------------------------------------------------
...
=================================================================================================
  $Log: /KiSS4/Database/DBOs/Stored Procedures/System/spXGetDBScheme.sql $
 * 
 * 7     28.04.10 15:32 Tabegglen
 * Include DefaultAlias in the resulting output dataset
 * 
 * 6     28.04.10 15:23 Tabegglen
 * DefaultAlias wird neu auch aus dem DBSchema extrahiert
 * 
...
BEGIN
  ...
  */
  ...
  (
    ...
    DefaultAlias CHAR(3)						  -- store the "DefaultAlias"
  );
  ...
  INSERT INTO @Object
    ...
    FROM sys.objects                    OBJ
      ...
      -- DefaultAlias
      LEFT JOIN dbo.XTable				TBL ON TBL.TableName = OBJ.name

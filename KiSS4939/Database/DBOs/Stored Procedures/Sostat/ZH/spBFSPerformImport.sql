...
GO
/*===============================================================================================
  $Archive: /KiSS4/Database/DBOs/Stored Procedures/Sostat/spBFSPerformImport.sql $
  $Author: Rhesterberg $
  $Modtime: 12.07.10 14:50 $
  $Revision: 11 $
=================================================================================================
  Description
-------------------------------------------------------------------------------------------------
  ...
  TEST:    .
=================================================================================================
  $Log: /KiSS4/Database/DBOs/Stored Procedures/Sostat/spBFSPerformImport.sql $
 * 11    5.11.10 psl
 * #8710: Stichtag wird neu als Parameter mitgegeben, damit Variablen 16.xx für Anfangszustandsdossiers leer bleiben können
 * 
 * 10    12.07.10 14:50 Rhesterberg
 * #6208: Stichtag-Regel bei Dossiergenerierung überprüfen 
 * 
 * 9     19.10.09 4:34 Mweber
 * Berücksichtigung von fnBFSBetrag in der Abarbeitungsreihenfolge)
 * 
 * 8     19.09.09 16:01 Ckaeser
 * #5004 Übernahme/Abgleich ZH
 * 
 * 6     27.02.09 17:51 Cjaeggi
 * Added fix for lov with boolean values
 *
 * 5     27.11.08 16:23 Ckaeser
 *
 * 4     4.11.08 13:53 dmast
 *
 * 3     23.10.08 11:08 Aboss
 * Added: input parameters LovName and Variable
 *
 * 2     16.09.08 19:25 dmast
 *
...
BEGIN
	...
	WHERE DOS.BFSDossierID = @BFSDossierID
		...
		AND HerkunftSQL IS NOT NULL
        AND BFSLeistungsfilterCodes LIKE '%' + CONVERT(
			varchar, CASE DOS.BFSLeistungsartCode
				WHEN 1  THEN 1 -- WSH
                WHEN 2  THEN 1 -- WSH
                WHEN 23 THEN 5 -- KKBB
                WHEN 25 THEN 4 -- ALBV

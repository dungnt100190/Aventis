...
SET ANSI_NULLS ON;
GO
EXECUTE dbo.spDropObject sp_alterdiagram;
GO
/*===============================================================================================
  $Archive: /KiSS4/Database/DBOs/Stored Procedures/DB_DiagramDesigner/sp_alterdiagram.sql $
  $Author: Cjaeggi $
...
-------------------------------------------------------------------------------------------------
  ...
  TEST:    .
=================================================================================================
  $Log: /KiSS4/Database/DBOs/Stored Procedures/DB_DiagramDesigner/sp_alterdiagram.sql $
 * 
...
GO
DENY  EXECUTE  ON [dbo].[sp_alterdiagram]  TO [guest] CASCADE
GO

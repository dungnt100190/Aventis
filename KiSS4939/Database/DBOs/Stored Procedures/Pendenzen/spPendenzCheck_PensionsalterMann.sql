...
GO
EXECUTE spDropObject spPendenzCheck_PensionsalterMann
GO
/*===============================================================================================
  $Archive: /Database/KISS4_BSS_MasterDev/Stored Procedures/spPendenzCheck_PensionsalterMann.sql $
  $Author: Lloreggia $
...
=================================================================================================
  Description
-------------------------------------------------------------------------------------------------
  SUMMARY:          Sucht nach Männern, die in Kürze das Pensionsalter erreichen
    @AnzahlTage:    Anzahl Tage, bevor ein Mann das Pensionsalter erreicht
    @Pensionsalter: Normales Pensionsalter für Männer
  -
  RETURNS:          Ein Datensatz mit anzulegenden Pendenzen
  -
  TEST:             EXEC dbo.spPendenzCheck_PensionsalterMann
=================================================================================================
  $Log: /Database/KISS4_BSS_MasterDev/Stored Procedures/spPendenzCheck_PensionsalterMann.sql $
 * 
...
CREATE PROCEDURE dbo.spPendenzCheck_PensionsalterMann
(
	@AnzahlTage INT = 90,
	@Pensionsalter INT = 65
)
AS
BEGIN
  ...
  SET @AutoGeneratedType = 5  -- PensionsalterMann
  SET @ReferenceTable = 'BaPerson'
  SET @Code = 32 --Pensionsalter Mann

	SELECT DISTINCT
    TaskSenderCode    = 5,  -- DbScript
    TaskReceiverCode  = 1,  -- Person
    TaskTypeCode      = @Code, --Pensionsalter Mann

...
SET ANSI_NULLS ON;
GO
EXECUTE dbo.spDropObject fnBDEGetHistMandantenNrPerDate;
GO
/*===============================================================================================
  $Archive: /Database/KiSS4_PI_MasterDev/Functions/BDE/fnBDEGetHistMandantenNrPerDate.sql $
  $Author: Lloreggia $
...
=================================================================================================
  Description
-------------------------------------------------------------------------------------------------
  SUMMARY: Use this function to get historised users's member-orgunit Mandantennummer for specified date
  ...
  -
  TEST:    SELECT [dbo].[fnBDEGetHistMandantenNrPerDate](1419, '2008-03-08', NULL)
           1419 = Ohnemus Peter, Member in BS Amriswil (KGS Thurgau/Schaffhausen)
=================================================================================================
  $Log: /Database/KiSS4_PI_MasterDev/Functions/BDE/fnBDEGetHistMandantenNrPerDate.sql $
 * 
...
CREATE FUNCTION dbo.fnBDEGetHistMandantenNrPerDate
(
  @UserID INT,
  @Date datetime,
  @OrgUnitID INT
...
AS BEGIN
  ...
  -----------------------------------------------------------------------------
  RETURN IsNull(dbo.fnOrgUnitHistoryHierarchyValue(@HistMemberOrgUnitID, @Date, 'mndnr'), -1)
END
GO
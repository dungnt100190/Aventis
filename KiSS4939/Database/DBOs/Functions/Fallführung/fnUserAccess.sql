...
GO
/*===============================================================================================
  $Archive: /Database/KISS4_BSS_MasterDev/Functions/fnUserAccess.sql $
  $Author: Lloreggia $
  $Modtime: 16.11.09 14:15 $
  $Revision: 5 $
=================================================================================================
  Description
-------------------------------------------------------------------------------------------------
  ...
  TEST:    .
=================================================================================================
  $Log: /Database/KISS4_BSS_MasterDev/Functions/fnUserAccess.sql $
 * 
...
AS RETURN (
  ...
  FROM dbo.FaLeistung                 FLE WITH (READUNCOMMITTED) 
    ...
    LEFT  JOIN dbo.FaLeistungZugriff  FLZ WITH (READUNCOMMITTED) ON FLZ.FaLeistungID = FLE.FaLeistungID 
																	...
																	AND dbo.fnUserAccessGastrechtGueltigkeitZeitbereich(dbo.fnDateSerial(YEAR(GETDATE()),MONTH(GETDATE()),DAY(GETDATE())), FLZ.DatumVon , FLZ.DatumBis) = 1

...
GO
EXECUTE dbo.spDropObject fnShGrundbedarfII_Person
GO
/*===============================================================================================
  $Archive: /Database/KISS4_BSS_MasterDev/Functions/fnShGrundbedarfII_Person.sql $
  $Author: Ckaeser $
...
-------------------------------------------------------------------------------------------------
  ...
  TEST:    .
=================================================================================================
  $Log: /Database/KISS4_BSS_MasterDev/Functions/fnShGrundbedarfII_Person.sql $
 * 

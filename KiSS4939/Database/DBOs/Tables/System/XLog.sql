...
CREATE NONCLUSTERED INDEX [IX_XLog_XLogCode] ON [dbo].[XLog] 
(
	[Source] ASC
...
ALTER TABLE [dbo].[XLog] ADD  CONSTRAINT [DF_XLog_NonPurgeable]  DEFAULT ((0)) FOR [NonPurgeable]
GO

ALTER TABLE [dbo].[XLog] ADD  CONSTRAINT [DF_XLog_Created]  DEFAULT (getdate()) FOR [Created]
GO

ALTER TABLE [dbo].[XLog] ADD  CONSTRAINT [DF_XLog_Modified]  DEFAULT (getdate()) FOR [Modified]
GO
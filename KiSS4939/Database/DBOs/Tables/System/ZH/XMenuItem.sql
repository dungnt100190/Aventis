...
/****** Object:  Index [IX_XMenuItem]    Script Date: 03/22/2012 10:40:23 ******/
...
/****** Object:  Index [IX_XMenuItem_ClassName]    Script Date: 03/22/2012 10:40:23 ******/
CREATE NONCLUSTERED INDEX [IX_XMenuItem_ClassName] ON [dbo].[XMenuItem] 
(
	[ClassName] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, DROP_EXISTING = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON, FILLFACTOR = 70) ON [SYSTEM]
GO

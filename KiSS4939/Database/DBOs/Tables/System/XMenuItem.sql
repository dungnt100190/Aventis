CREATE TABLE [dbo].[XMenuItem](
 ...
 CONSTRAINT [PK_XMenuItem] PRIMARY KEY NONCLUSTERED 
(
	[MenuItemID] ASC
...
/****** Object:  Index [IX_XMenuItem]    Script Date: 11/19/2009 11:17:23 ******/
CREATE CLUSTERED INDEX [IX_XMenuItem] ON [dbo].[XMenuItem] 
(
...
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Primärschlüssel für XMenuItem Records (nach Primärschlüssel-Standards)' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'XMenuItem', @level2type=N'COLUMN',@level2name=N'MenuItemID'
GO
...
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Fremdschlüssel (FK_XMenuItem_XMenuItem) => XMenuItem.MenuItemID' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'XMenuItem', @level2type=N'COLUMN',@level2name=N'ParentMenuItemID'
GO
...
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Fremdschlüssel (FK_XMenuItem_XClass) => XClass.ClassName' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'XMenuItem', @level2type=N'COLUMN',@level2name=N'ClassName'
GO

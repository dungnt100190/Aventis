...
UNION ALL SELECT 22,NULL,'Brantomyfonds','Brantomyfonds',NULL,NULL,NULL,1,0,'HS Zürich','2014-12-31'
...
--KGS BL ist Mosaik, dieser Fonds muss deshalb in der MOS-Datenbank aktualisiert werden
UNION ALL SELECT 61,'FLB-Kanton BL','FLB-Kanton BL','FLB-Kanton BL',NULL,NULL,NULL,1,0,'KGS BL',NULL
--KGS BL ist Mosaik, dieser Fonds muss deshalb in der MOS-Datenbank aktualisiert werden
UNION ALL SELECT 62,NULL,'Mosaik, Fonds, Stiftung','Fonds Stiftung Mosaik','Für Familien (mindestens 2 Generationen im gleichen Haushalt, eine davon minderjährig oder in Ausbildung).',NULL,NULL,1,0,'KGS BL',NULL

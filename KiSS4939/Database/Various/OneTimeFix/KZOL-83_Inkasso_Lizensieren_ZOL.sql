...
/*sortkey korrigieren*/
UPDATE XLOVCode 
set SortKey = 1 where Code = 1
and LOVName = 'IkForderungEinmalig'
UPDATE XLOVCode 
set SortKey = 2 where Code = 2
and LOVName = 'IkForderungEinmalig'
UPDATE XLOVCode 
set SortKey = 3 where Code = 3
and LOVName = 'IkForderungEinmalig'
UPDATE XLOVCode 
set SortKey = 4 where Code = 4
and LOVName = 'IkForderungEinmalig'
UPDATE XLOVCode 
set SortKey = 5 where Code = 5
and LOVName = 'IkForderungEinmalig'
UPDATE XLOVCode 
set SortKey = 6 where Code = 6
and LOVName = 'IkForderungEinmalig'
UPDATE XLOVCode 
set SortKey = 7 where Code = 7
and LOVName = 'IkForderungEinmalig'
UPDATE XLOVCode 
set SortKey = 8 where Code = 8
and LOVName = 'IkForderungEinmalig'
UPDATE XLOVCode 
set SortKey = 9 where Code = 9
and LOVName = 'IkForderungEinmalig'
UPDATE XLOVCode 
set SortKey = 10 where Code = 10
and LOVName = 'IkForderungEinmalig'
UPDATE XLOVCode 
set SortKey = 11 where Code = 11
and LOVName = 'IkForderungEinmalig'
UPDATE XLOVCode 
set SortKey = 10 where Code = 14
and LOVName = 'IkForderungEinmalig'
UPDATE XLOVCode 
set SortKey = 12 where Code = 13
and LOVName = 'IkForderungEinmalig'
UPDATE XLOVCode 
set SortKey = 13 where Code = 12
and LOVName = 'IkForderungEinmalig'
UPDATE XLOVCode 
set SortKey = 14 where Code = 32
and LOVName = 'IkForderungEinmalig'
UPDATE XLOVCode 
set SortKey = 15 where Code = 41
and LOVName = 'IkForderungEinmalig'
UPDATE XLOVCode 
set SortKey = 16 where Code = 51
and LOVName = 'IkForderungEinmalig'
UPDATE XLOVCode 
set SortKey = 17 where Code = 62
and LOVName = 'IkForderungEinmalig'
UPDATE XLOVCode 
set SortKey = 18 where Code = 64
and LOVName = 'IkForderungEinmalig'
UPDATE XLOVCode 
set SortKey = 19 where Code = 16
and LOVName = 'IkForderungEinmalig'
UPDATE XLOVCode 
set SortKey = 20 where Code = 15
and LOVName = 'IkForderungEinmalig'
UPDATE XLOVCode 
set SortKey = 21 where Code = 34
and LOVName = 'IkForderungEinmalig'
UPDATE XLOVCode 
set SortKey = 22 where Code = 33
and LOVName = 'IkForderungEinmalig'
UPDATE XLOVCode 
set SortKey = 23 where Code = 42
and LOVName = 'IkForderungEinmalig'
UPDATE XLOVCode 
set SortKey = 24 where Code = 52
and LOVName = 'IkForderungEinmalig'
UPDATE XLOVCode 
set SortKey = 25 where Code = 63
and LOVName = 'IkForderungEinmalig'
UPDATE XLOVCode 
set SortKey = 26 where Code = 65
and LOVName = 'IkForderungEinmalig'
UPDATE XLOVCode 
set SortKey = 27 where Code = 30
and LOVName = 'IkForderungEinmalig'
UPDATE XLOVCode 
set SortKey = 28 where Code = 40
and LOVName = 'IkForderungEinmalig'
UPDATE XLOVCode 
set SortKey = 29 where Code = 50
and LOVName = 'IkForderungEinmalig'
UPDATE XLOVCode 
set SortKey = 30 where Code = 60
and LOVName = 'IkForderungEinmalig'
UPDATE XLOVCode 
set SortKey = 31 where Code = 31
and LOVName = 'IkForderungEinmalig'
UPDATE XLOVCode 
set SortKey = 32 where Code = 61
and LOVName = 'IkForderungEinmalig'
UPDATE XLOVCode 
set SortKey = 33 where Code = 99
and LOVName = 'IkForderungEinmalig'

INSERT INTO XLOVCode (XLOVID, LOVName, Code, Text, SortKey, ShortText, BFSCode, Value1, Value2, Value3, Description, LOVCodeName, IsActive, System) VALUES (248, 'IkIndexTyp', 7, 'BFS Dez 2010', 0, NULL, NULL, '7', NULL, NULL, NULL, NULL, 1, 0)
...
--------------------------------------------------
-- Step: XMenuItem für Inkasso Handbuch hinzufügen
-------------------------------------------------------------------------------
PRINT ('Info: XMenuItem für Inkasso Handbuch hinzufügen');
IF NOT EXISTS(SELECT TOP 1 1 FROM dbo.XMenuItem WHERE ClassName = 'FrmManualInkasso')
BEGIN
  DECLARE @ParentMenuItemID INT;
  SELECT @ParentMenuItemID = MenuItemID
  FROM dbo.XMenuItem MNU WITH (READUNCOMMITTED)
  WHERE ParentMenuItemID = 8
    AND Caption = 'Handbücher';
    
  INSERT INTO dbo.XMenuItem(ParentMenuItemID, Caption, ImageIndex, SortKey, ClassName)
    VALUES  (@ParentMenuItemID, ' Handbuch Inkasso', 82, 2, 'FrmManualInkasso');
END;
GO
-------------------------------------------------------------------------------

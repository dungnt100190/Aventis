...
INSERT INTO @koaSoll (BgKostenartID, Name, KontoNr, Splittingart, Quoting, WVZeile, GefKategorieTyp, GefKategorie, Inkassoprovision) SELECT  BgKostenartID = 10066, Name = 'Unterbringung Minderjährige bei Privaten mit KS ZGB', KontoNr = '461', Splittingart = 'Monat', Quoting = 0, WCZeile = '5. a) Kostgelder', GefKategorieTyp = 'Aufwand', GefKategorie = 'Platzierungskosten aufgrund vormundschaftlicher Massnahmen', Inkassoprovision = 0;
...
INSERT INTO @koaSoll (BgKostenartID, Name, KontoNr, Splittingart, Quoting, WVZeile, GefKategorieTyp, GefKategorie, Inkassoprovision) SELECT  BgKostenartID = 10034, Name = 'Alimentenbevorschussung (Ablieferung)', KontoNr = '681', Splittingart = 'Monat', Quoting = 0, WCZeile = '', GefKategorieTyp = '', GefKategorie = '', Inkassoprovision = 0;

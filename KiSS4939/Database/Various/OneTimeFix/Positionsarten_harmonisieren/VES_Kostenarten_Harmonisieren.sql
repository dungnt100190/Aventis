...
INSERT INTO @koaSoll (BgKostenartID, Name, KontoNr, Splittingart, Quoting, WVZeile, GefKategorieTyp, GefKategorie, Inkassoprovision) SELECT  BgKostenartID = 10002, Name = 'Zulagen IZU', KontoNr = '101', Splittingart = 'Monat', Quoting = 0, WCZeile = '1. Lebensunterhalt', GefKategorieTyp = 'Aufwand', GefKategorie = 'IZU/MIZ (Zulagen)', Inkassoprovision = 0;
...
INSERT INTO @koaSoll (BgKostenartID, Name, KontoNr, Splittingart, Quoting, WVZeile, GefKategorieTyp, GefKategorie, Inkassoprovision) SELECT  BgKostenartID = 10062, Name = 'Zulagen MIZ', KontoNr = '103', Splittingart = 'Monat', Quoting = 0, WCZeile = '1. Lebensunterhalt', GefKategorieTyp = 'Aufwand', GefKategorie = 'IZU/MIZ (Zulagen)', Inkassoprovision = 0;
INSERT INTO @koaSoll (BgKostenartID, Name, KontoNr, Splittingart, Quoting, WVZeile, GefKategorieTyp, GefKategorie, Inkassoprovision) SELECT  BgKostenartID = 10063, Name = 'Zulagen EFB', KontoNr = '105', Splittingart = 'Monat', Quoting = 0, WCZeile = '1. Lebensunterhalt', GefKategorieTyp = 'Aufwand', GefKategorie = 'EFB (Einkommensfreibetrag)', Inkassoprovision = 0;
INSERT INTO @koaSoll (BgKostenartID, Name, KontoNr, Splittingart, Quoting, WVZeile, GefKategorieTyp, GefKategorie, Inkassoprovision) SELECT  BgKostenartID = 10064, Name = 'Auswärtige Verpflegung', KontoNr = '107', Splittingart = 'Monat', Quoting = 0, WCZeile = '1. Lebensunterhalt', GefKategorieTyp = 'Aufwand', GefKategorie = 'IZU/MIZ (Zulagen)', Inkassoprovision = 0;
...
INSERT INTO @koaSoll (BgKostenartID, Name, KontoNr, Splittingart, Quoting, WVZeile, GefKategorieTyp, GefKategorie, Inkassoprovision) SELECT  BgKostenartID = 10065, Name = 'Mietnebenkosten', KontoNr = '111', Splittingart = 'Monat', Quoting = 1, WCZeile = '2. Wohnung', GefKategorieTyp = 'Aufwand', GefKategorie = 'Wohnkosten inkl. Wohnnebenkosten', Inkassoprovision = 0;
...
INSERT INTO @koaSoll (BgKostenartID, Name, KontoNr, Splittingart, Quoting, WVZeile, GefKategorieTyp, GefKategorie, Inkassoprovision) SELECT  BgKostenartID = 10010, Name = 'Pflegetaxen in Krankenhäusern und Kuranstalten', KontoNr = '400', Splittingart = 'Monat', Quoting = 0, WCZeile = '5. a) Kostgelder', GefKategorieTyp = 'Aufwand', GefKategorie = 'Gesundheitskosten ohne KK-Prämien Grundversicherung', Inkassoprovision = 0;
INSERT INTO @koaSoll (BgKostenartID, Name, KontoNr, Splittingart, Quoting, WVZeile, GefKategorieTyp, GefKategorie, Inkassoprovision) SELECT  BgKostenartID = 10011, Name = 'Unterbringung in Vollzugsinstitutionen (Haftanstalten)', KontoNr = '410', Splittingart = 'Monat', Quoting = 0, WCZeile = '5. a) Kostgelder', GefKategorieTyp = 'Aufwand', GefKategorie = 'Übrige Platzierungskosten', Inkassoprovision = 0;
...
INSERT INTO @koaSoll (BgKostenartID, Name, KontoNr, Splittingart, Quoting, WVZeile, GefKategorieTyp, GefKategorie, Inkassoprovision) SELECT  BgKostenartID = 10066, Name = 'Unterbringung in stationären Einrichtungen mit KS ZGB', KontoNr = '422', Splittingart = 'Monat', Quoting = 0, WCZeile = '5. a) Kostgelder', GefKategorieTyp = 'Aufwand', GefKategorie = 'Platzierungskosten aufgrund vormundschaftlicher Massnahmen', Inkassoprovision = 0;
...
INSERT INTO @koaSoll (BgKostenartID, Name, KontoNr, Splittingart, Quoting, WVZeile, GefKategorieTyp, GefKategorie, Inkassoprovision) SELECT  BgKostenartID = 10067, Name = 'Unterbringung in stationären Einrichtungen für Minderjährige', KontoNr = '432', Splittingart = 'Monat', Quoting = 0, WCZeile = '5. a) Kostgelder', GefKategorieTyp = 'Aufwand', GefKategorie = 'Übrige Platzierungskosten', Inkassoprovision = 0;
INSERT INTO @koaSoll (BgKostenartID, Name, KontoNr, Splittingart, Quoting, WVZeile, GefKategorieTyp, GefKategorie, Inkassoprovision) SELECT  BgKostenartID = 10068, Name = 'Ambulante Massnahmen Minderjährige', KontoNr = '433', Splittingart = 'Monat', Quoting = 0, WCZeile = '5. a) Kostgelder', GefKategorieTyp = 'Aufwand', GefKategorie = 'Kosten für vorsorgliche ambulante Massnahmen', Inkassoprovision = 0;
INSERT INTO @koaSoll (BgKostenartID, Name, KontoNr, Splittingart, Quoting, WVZeile, GefKategorieTyp, GefKategorie, Inkassoprovision) SELECT  BgKostenartID = 10069, Name = 'Ambulante Massnahmen Erwachsene', KontoNr = '434', Splittingart = 'Monat', Quoting = 0, WCZeile = '5. a) Kostgelder', GefKategorieTyp = 'Aufwand', GefKategorie = 'Kosten für vorsorgliche ambulante Massnahmen', Inkassoprovision = 0;
INSERT INTO @koaSoll (BgKostenartID, Name, KontoNr, Splittingart, Quoting, WVZeile, GefKategorieTyp, GefKategorie, Inkassoprovision) SELECT  BgKostenartID = 10070, Name = 'Ambulante Massnahmen Minderjährige mit KS ZGB', KontoNr = '435', Splittingart = 'Monat', Quoting = 0, WCZeile = '5. a) Kostgelder', GefKategorieTyp = 'Aufwand', GefKategorie = 'Kosten für vorsorgliche ambulante Massnahmen', Inkassoprovision = 0;
INSERT INTO @koaSoll (BgKostenartID, Name, KontoNr, Splittingart, Quoting, WVZeile, GefKategorieTyp, GefKategorie, Inkassoprovision) SELECT  BgKostenartID = 10071, Name = 'Ambulante Massnahmen Erwachsene mit ES ZGB', KontoNr = '436', Splittingart = 'Monat', Quoting = 0, WCZeile = '5. a) Kostgelder', GefKategorieTyp = 'Aufwand', GefKategorie = 'Kosten für vorsorgliche ambulante Massnahmen', Inkassoprovision = 0;
...
INSERT INTO @koaSoll (BgKostenartID, Name, KontoNr, Splittingart, Quoting, WVZeile, GefKategorieTyp, GefKategorie, Inkassoprovision) SELECT  BgKostenartID = 10018, Name = 'Pensionsgelder (Hotellerie, Pensionen, Private)', KontoNr = '450', Splittingart = 'Monat', Quoting = 0, WCZeile = '5. a) Kostgelder', GefKategorieTyp = 'Aufwand', GefKategorie = 'Übrige Platzierungskosten', Inkassoprovision = 0;
...
INSERT INTO @koaSoll (BgKostenartID, Name, KontoNr, Splittingart, Quoting, WVZeile, GefKategorieTyp, GefKategorie, Inkassoprovision) SELECT  BgKostenartID = 10061, Name = 'Zuschuss nach Dekret', KontoNr = '550', Splittingart = 'Monat', Quoting = 0, WCZeile = '', GefKategorieTyp = '', GefKategorie = '', Inkassoprovision = 0;
INSERT INTO @koaSoll (BgKostenartID, Name, KontoNr, Splittingart, Quoting, WVZeile, GefKategorieTyp, GefKategorie, Inkassoprovision) SELECT  BgKostenartID = 10027, Name = 'Ablieferungen', KontoNr = '600', Splittingart = 'Monat', Quoting = 0, WCZeile = '6. Andere Aufwendungen', GefKategorieTyp = '', GefKategorie = '', Inkassoprovision = 0;
INSERT INTO @koaSoll (BgKostenartID, Name, KontoNr, Splittingart, Quoting, WVZeile, GefKategorieTyp, GefKategorie, Inkassoprovision) SELECT  BgKostenartID = 10028, Name = 'Ablieferungen an Behörde (ZUG)', KontoNr = '601', Splittingart = 'Monat', Quoting = 0, WCZeile = '', GefKategorieTyp = '', GefKategorie = '', Inkassoprovision = 0;
INSERT INTO @koaSoll (BgKostenartID, Name, KontoNr, Splittingart, Quoting, WVZeile, GefKategorieTyp, GefKategorie, Inkassoprovision) SELECT  BgKostenartID = 10029, Name = 'Ablieferungen übrige Behörden', KontoNr = '602', Splittingart = 'Monat', Quoting = 0, WCZeile = '', GefKategorieTyp = '', GefKategorie = '', Inkassoprovision = 0;
INSERT INTO @koaSoll (BgKostenartID, Name, KontoNr, Splittingart, Quoting, WVZeile, GefKategorieTyp, GefKategorie, Inkassoprovision) SELECT  BgKostenartID = 10030, Name = 'Ablieferungen Behörden (Bund)', KontoNr = '603', Splittingart = 'Monat', Quoting = 0, WCZeile = '', GefKategorieTyp = '', GefKategorie = '', Inkassoprovision = 0;
...
INSERT INTO @koaSoll (BgKostenartID, Name, KontoNr, Splittingart, Quoting, WVZeile, GefKategorieTyp, GefKategorie, Inkassoprovision) SELECT  BgKostenartID = 10073, Name = 'Ablieferung Mehreinnahmen', KontoNr = '605', Splittingart = 'Monat', Quoting = 0, WCZeile = '6. Andere Aufwendungen', GefKategorieTyp = '', GefKategorie = '', Inkassoprovision = 0;
INSERT INTO @koaSoll (BgKostenartID, Name, KontoNr, Splittingart, Quoting, WVZeile, GefKategorieTyp, GefKategorie, Inkassoprovision) SELECT  BgKostenartID = 10032, Name = 'Alimentebevorschussung', KontoNr = '680', Splittingart = 'Monat', Quoting = 0, WCZeile = '', GefKategorieTyp = '', GefKategorie = '', Inkassoprovision = 0;
INSERT INTO @koaSoll (BgKostenartID, Name, KontoNr, Splittingart, Quoting, WVZeile, GefKategorieTyp, GefKategorie, Inkassoprovision) SELECT  BgKostenartID = 10033, Name = 'Alimentenbevorschussung (Ablieferung)', KontoNr = '681', Splittingart = 'Monat', Quoting = 0, WCZeile = '', GefKategorieTyp = '', GefKategorie = '', Inkassoprovision = 0;
...
INSERT INTO @koaSoll (BgKostenartID, Name, KontoNr, Splittingart, Quoting, WVZeile, GefKategorieTyp, GefKategorie, Inkassoprovision) SELECT  BgKostenartID = 10036, Name = 'Persönliche Rückerstattungen', KontoNr = '700', Splittingart = 'Monat', Quoting = 0, WCZeile = '10. Rückerstattungen', GefKategorieTyp = 'Ertrag', GefKategorie = 'Persönliche Rückerstattungen', Inkassoprovision = 1;
INSERT INTO @koaSoll (BgKostenartID, Name, KontoNr, Splittingart, Quoting, WVZeile, GefKategorieTyp, GefKategorie, Inkassoprovision) SELECT  BgKostenartID = 10037, Name = 'Rückerstattungen aus Hinterlassenschaften', KontoNr = '701', Splittingart = 'Monat', Quoting = 0, WCZeile = '10. Rückerstattungen', GefKategorieTyp = 'Ertrag', GefKategorie = 'Persönliche Rückerstattungen', Inkassoprovision = 1;
INSERT INTO @koaSoll (BgKostenartID, Name, KontoNr, Splittingart, Quoting, WVZeile, GefKategorieTyp, GefKategorie, Inkassoprovision) SELECT  BgKostenartID = 10038, Name = 'Leistungen von Krankenkassen/UVG', KontoNr = '730', Splittingart = 'Monat', Quoting = 0, WCZeile = '8. a) Versicherungsleistungen Krankenkasse', GefKategorieTyp = 'Ertrag', GefKategorie = 'Erträge Gesundheitskosten (KK-Rückerstattungen)', Inkassoprovision = 0;
INSERT INTO @koaSoll (BgKostenartID, Name, KontoNr, Splittingart, Quoting, WVZeile, GefKategorieTyp, GefKategorie, Inkassoprovision) SELECT  BgKostenartID = 10039, Name = 'SUVA-Renten/Militärvers./Alterspensionen', KontoNr = '740', Splittingart = 'Monat', Quoting = 1, WCZeile = '11. Bundesbeiträge', GefKategorieTyp = 'Ertrag', GefKategorie = 'Einkommen aus übrigen Sozialversicherungen', Inkassoprovision = 0;
INSERT INTO @koaSoll (BgKostenartID, Name, KontoNr, Splittingart, Quoting, WVZeile, GefKategorieTyp, GefKategorie, Inkassoprovision) SELECT  BgKostenartID = 10040, Name = 'Alimentenbevorschussung', KontoNr = '780', Splittingart = 'Monat', Quoting = 0, WCZeile = '', GefKategorieTyp = '', GefKategorie = '', Inkassoprovision = 0;
INSERT INTO @koaSoll (BgKostenartID, Name, KontoNr, Splittingart, Quoting, WVZeile, GefKategorieTyp, GefKategorie, Inkassoprovision) SELECT  BgKostenartID = 10041, Name = 'Kinderalimente und - Zulagen Vermittlung Bevorschussung', KontoNr = '781', Splittingart = 'Monat', Quoting = 0, WCZeile = '', GefKategorieTyp = '', GefKategorie = '', Inkassoprovision = 0;
...
INSERT INTO @koaSoll (BgKostenartID, Name, KontoNr, Splittingart, Quoting, WVZeile, GefKategorieTyp, GefKategorie, Inkassoprovision) SELECT  BgKostenartID = 10044, Name = 'Heimatliche Vergütung ZUG', KontoNr = '800', Splittingart = 'Monat', Quoting = 0, WCZeile = '', GefKategorieTyp = 'Ertrag', GefKategorie = 'Heimatliche Vergütungen', Inkassoprovision = 0;
INSERT INTO @koaSoll (BgKostenartID, Name, KontoNr, Splittingart, Quoting, WVZeile, GefKategorieTyp, GefKategorie, Inkassoprovision) SELECT  BgKostenartID = 10045, Name = 'Heimatliche Vergütung Ausländer', KontoNr = '801', Splittingart = 'Monat', Quoting = 0, WCZeile = '', GefKategorieTyp = 'Ertrag', GefKategorie = 'Heimatliche Vergütungen', Inkassoprovision = 0;
INSERT INTO @koaSoll (BgKostenartID, Name, KontoNr, Splittingart, Quoting, WVZeile, GefKategorieTyp, GefKategorie, Inkassoprovision) SELECT  BgKostenartID = 10046, Name = 'Übrige behördliche Vergütungen', KontoNr = '802', Splittingart = 'Monat', Quoting = 1, WCZeile = '', GefKategorieTyp = '', GefKategorie = '', Inkassoprovision = 0;
INSERT INTO @koaSoll (BgKostenartID, Name, KontoNr, Splittingart, Quoting, WVZeile, GefKategorieTyp, GefKategorie, Inkassoprovision) SELECT  BgKostenartID = 10047, Name = 'Arbeitslosenversicherung', KontoNr = '830', Splittingart = 'Monat', Quoting = 1, WCZeile = '11. Bundesbeiträge', GefKategorieTyp = 'Ertrag', GefKategorie = 'ALV', Inkassoprovision = 0;
INSERT INTO @koaSoll (BgKostenartID, Name, KontoNr, Splittingart, Quoting, WVZeile, GefKategorieTyp, GefKategorie, Inkassoprovision) SELECT  BgKostenartID = 10048, Name = 'Stipendien', KontoNr = '840', Splittingart = 'Monat', Quoting = 1, WCZeile = '11. Bundesbeiträge', GefKategorieTyp = 'Ertrag', GefKategorie = 'Übrige Einkommen', Inkassoprovision = 0;
INSERT INTO @koaSoll (BgKostenartID, Name, KontoNr, Splittingart, Quoting, WVZeile, GefKategorieTyp, GefKategorie, Inkassoprovision) SELECT  BgKostenartID = 10049, Name = 'Übrige Einnahmen', KontoNr = '850', Splittingart = 'Monat', Quoting = 1, WCZeile = '10. Rückerstattungen', GefKategorieTyp = 'Ertrag', GefKategorie = 'Übrige Einkommen', Inkassoprovision = 0;
...
INSERT INTO @koaSoll (BgKostenartID, Name, KontoNr, Splittingart, Quoting, WVZeile, GefKategorieTyp, GefKategorie, Inkassoprovision) SELECT  BgKostenartID = 10074, Name = 'Kinderzulage Lohn', KontoNr = '854', Splittingart = 'Monat', Quoting = 1, WCZeile = '10. Rückerstattungen', GefKategorieTyp = 'Ertrag', GefKategorie = 'Familienzulagen', Inkassoprovision = 1;
INSERT INTO @koaSoll (BgKostenartID, Name, KontoNr, Splittingart, Quoting, WVZeile, GefKategorieTyp, GefKategorie, Inkassoprovision) SELECT  BgKostenartID = 10075, Name = 'Kinderzulage Versicherung', KontoNr = '855', Splittingart = 'Monat', Quoting = 1, WCZeile = '10. Rückerstattungen', GefKategorieTyp = 'Ertrag', GefKategorie = 'Familienzulagen', Inkassoprovision = 1;
INSERT INTO @koaSoll (BgKostenartID, Name, KontoNr, Splittingart, Quoting, WVZeile, GefKategorieTyp, GefKategorie, Inkassoprovision) SELECT  BgKostenartID = 10053, Name = 'Frauenrenten,Kinderzulagen im Unterstützungs- u. Vermittlungsfall, KA Verm.', KontoNr = '870', Splittingart = 'Monat', Quoting = 0, WCZeile = '9. Verwandtenbeiträge', GefKategorieTyp = 'Ertrag', GefKategorie = 'Kinderalimente und Ehegattenalimente', Inkassoprovision = 1;
INSERT INTO @koaSoll (BgKostenartID, Name, KontoNr, Splittingart, Quoting, WVZeile, GefKategorieTyp, GefKategorie, Inkassoprovision) SELECT  BgKostenartID = 10054, Name = 'Elternbeiträge', KontoNr = '871', Splittingart = 'Monat', Quoting = 1, WCZeile = '9. Verwandtenbeiträge', GefKategorieTyp = 'Ertrag', GefKategorie = 'Elternbeiträge/Verwandtenunterstützung', Inkassoprovision = 1;
...
INSERT INTO @koaSoll (BgKostenartID, Name, KontoNr, Splittingart, Quoting, WVZeile, GefKategorieTyp, GefKategorie, Inkassoprovision) SELECT  BgKostenartID = 10056, Name = 'Verwandtenbeiträge', KontoNr = '880', Splittingart = 'Monat', Quoting = 0, WCZeile = '9. Verwandtenbeiträge', GefKategorieTyp = 'Ertrag', GefKategorie = 'Elternbeiträge/Verwandtenunterstützung', Inkassoprovision = 1;
INSERT INTO @koaSoll (BgKostenartID, Name, KontoNr, Splittingart, Quoting, WVZeile, GefKategorieTyp, GefKategorie, Inkassoprovision) SELECT  BgKostenartID = 10057, Name = 'AHV-Renten', KontoNr = '900', Splittingart = 'Monat', Quoting = 1, WCZeile = '8. Versicherungsleistungen AHV', GefKategorieTyp = 'Ertrag', GefKategorie = 'Einkommen aus übrigen Sozialversicherungen', Inkassoprovision = 0;
INSERT INTO @koaSoll (BgKostenartID, Name, KontoNr, Splittingart, Quoting, WVZeile, GefKategorieTyp, GefKategorie, Inkassoprovision) SELECT  BgKostenartID = 10058, Name = 'EL f. AHV-/IV-Bezüger', KontoNr = '901', Splittingart = 'Monat', Quoting = 1, WCZeile = '8. Versicherungsleistungen AHV', GefKategorieTyp = 'Ertrag', GefKategorie = 'Einkommen aus übrigen Sozialversicherungen', Inkassoprovision = 0;
INSERT INTO @koaSoll (BgKostenartID, Name, KontoNr, Splittingart, Quoting, WVZeile, GefKategorieTyp, GefKategorie, Inkassoprovision) SELECT  BgKostenartID = 10059, Name = 'HE f. AHV-/IV-Bezüger', KontoNr = '902', Splittingart = 'Monat', Quoting = 1, WCZeile = '8. Versicherungsleistungen AHV', GefKategorieTyp = 'Ertrag', GefKategorie = 'Einkommen aus übrigen Sozialversicherungen', Inkassoprovision = 0;
INSERT INTO @koaSoll (BgKostenartID, Name, KontoNr, Splittingart, Quoting, WVZeile, GefKategorieTyp, GefKategorie, Inkassoprovision) SELECT  BgKostenartID = 10060, Name = 'IV-Renten', KontoNr = '903', Splittingart = 'Monat', Quoting = 1, WCZeile = '8. Versicherungsleistungen AHV', GefKategorieTyp = 'Ertrag', GefKategorie = 'IV-Taggelder und IV-Rente', Inkassoprovision = 0;
...
INSERT INTO @koaSoll (BgKostenartID, Name, KontoNr, Splittingart, Quoting, WVZeile, GefKategorieTyp, GefKategorie, Inkassoprovision) SELECT  BgKostenartID = 10076, Name = 'IV-Taggeld', KontoNr = '905', Splittingart = 'Monat', Quoting = 0, WCZeile = '8. Versicherungsleistungen AHV', GefKategorieTyp = 'Ertrag', GefKategorie = 'IV-Taggelder und IV-Rente', Inkassoprovision = 0;

...
INSERT INTO @poaSoll (Aktion, BgPositionsartCode_Alt, BgPositionsartCode_Neu, VarName, BgKategorieCode, KoAKontoNr, Name_Alt, Name_Neu, BgGruppeCodeName, ProPerson, ProUE, VerwaltungSD_Default, Spezkonto, DatumVon, DatumBis, ModulID, [System], SortKey, Masterbudget_EditMask, Monatsbudget_EditMask, sqlRichtlinie, Verrechenbar) SELECT  Aktion = 'U', BgPositionsartCode_Alt = 161001, BgPositionsartCode_Neu = 90030, VarName = '10102', BgKategorieCode = @BgKategorieCode , KoAKontoNr = '905', Name_Alt = 'IV-Taggeld', Name_Neu = 'IV-Taggeld', BgGruppeCodeName = 'Einkommen aus Versicherungsleistungen', ProPerson = 1, ProUE = 0, VerwaltungSD_Default = 0, Spezkonto = 0, DatumVon = '20110101', DatumBis = NULL, ModulID = 3, [System] = 1, SortKey = 4, Masterbudget_EditMask = 2028031, Monatsbudget_EditMask = 495, sqlRichtlinie = NULL, Verrechenbar = 1;
...
INSERT INTO @poaSoll (Aktion, BgPositionsartCode_Alt, BgPositionsartCode_Neu, VarName, BgKategorieCode, KoAKontoNr, Name_Alt, Name_Neu, BgGruppeCodeName, ProPerson, ProUE, VerwaltungSD_Default, Spezkonto, DatumVon, DatumBis, ModulID, [System], SortKey, Masterbudget_EditMask, Monatsbudget_EditMask, sqlRichtlinie, Verrechenbar) SELECT  Aktion = 'U', BgPositionsartCode_Alt = 31050, BgPositionsartCode_Neu = 31050, VarName = '12.02', BgKategorieCode = @BgKategorieCode , KoAKontoNr = '850', Name_Alt = 'Vermögensverbrauch', Name_Neu = 'Vermögensverzehr', BgGruppeCodeName = 'Vermögen und Vermögensverbrauch', ProPerson = 1, ProUE = 0, VerwaltungSD_Default = 0, Spezkonto = 0, DatumVon = '20130501', DatumBis = NULL, ModulID = 3, [System] = 1, SortKey = 1, Masterbudget_EditMask = 2093567, Monatsbudget_EditMask = 511, sqlRichtlinie = NULL, Verrechenbar = 1;
...
INSERT INTO @poaSoll (Aktion, BgPositionsartCode_Alt, BgPositionsartCode_Neu, VarName, BgKategorieCode, KoAKontoNr, Name_Alt, Name_Neu, BgGruppeCodeName, ProPerson, ProUE, VerwaltungSD_Default, Spezkonto, DatumVon, DatumBis, ModulID, [System], SortKey, Masterbudget_EditMask, Monatsbudget_EditMask, sqlRichtlinie, Verrechenbar) SELECT  Aktion = 'U', BgPositionsartCode_Alt = 160912, BgPositionsartCode_Neu = NULL, VarName = '', BgKategorieCode = @BgKategorieCode , KoAKontoNr = '880', Name_Alt = 'Verwandtenunterstützung', Name_Neu = 'Verwandtenunterstützung', BgGruppeCodeName = 'Erwerbseinkommen', ProPerson = 0, ProUE = 0, VerwaltungSD_Default = 1, Spezkonto = 0, DatumVon = NULL, DatumBis = NULL, ModulID = 3, [System] = 1, SortKey = 5, Masterbudget_EditMask = 2093567, Monatsbudget_EditMask = 511, sqlRichtlinie = NULL, Verrechenbar = 1;
INSERT INTO @poaSoll (Aktion, BgPositionsartCode_Alt, BgPositionsartCode_Neu, VarName, BgKategorieCode, KoAKontoNr, Name_Alt, Name_Neu, BgGruppeCodeName, ProPerson, ProUE, VerwaltungSD_Default, Spezkonto, DatumVon, DatumBis, ModulID, [System], SortKey, Masterbudget_EditMask, Monatsbudget_EditMask, sqlRichtlinie, Verrechenbar) SELECT  Aktion = 'U', BgPositionsartCode_Alt = 160913, BgPositionsartCode_Neu = NULL, VarName = '', BgKategorieCode = @BgKategorieCode , KoAKontoNr = '851', Name_Alt = 'Diverses', Name_Neu = 'Diverses', BgGruppeCodeName = 'Erwerbseinkommen', ProPerson = 0, ProUE = 0, VerwaltungSD_Default = 1, Spezkonto = 0, DatumVon = NULL, DatumBis = NULL, ModulID = 3, [System] = 1, SortKey = 7, Masterbudget_EditMask = 1835519, Monatsbudget_EditMask = 448, sqlRichtlinie = NULL, Verrechenbar = 1;

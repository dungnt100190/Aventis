...
VALUES ('Krank ''N Kasse', 10, 1, 0, 0, dbo.fnGetDBRowCreatorModifier(@UserID), dbo.fnGetDBRowCreatorModifier(@UserID));
...
---------------
INSERT INTO [BaInstitution] ([Name], [BaInstitutionArtCode], [Aktiv], [Debitor], [Kreditor], [Creator], [Modifier]) 
VALUES ('Test Immo', 16, 1, 0, 0, dbo.fnGetDBRowCreatorModifier(@UserID), dbo.fnGetDBRowCreatorModifier(@UserID));

...
WHERE BBG.BgBudgetID = @BgBudgetID
  --AND BBG.BgBewilligungStatusCode = 5 -- nur bewilligte' , ContextForms =  N'WhMonatsbudget,CtlWhBudget' , ParentReportName =  null , ReportSortKey = 1, System =  0 
FROM XQuery QRY
...
*/
  ORDER BY IdGroup, FBL.KbBuchungID, KbBuchungKostenartID' ,  null ,  N'ShPapierverfuegungBuchhaltung' ,  null ,  0 );
...
ORDER BY Name' ,  null ,  N'ShPapierverfuegungBuchhaltung' ,  null ,  0 );

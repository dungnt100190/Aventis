-- Insert Script for KBErfolgsrechnung
-- MD5:0X09B451BD85B3F1292CFEEA5718B51D85_0X83EC8E54FE35A79FE7DE84F8F1DF98DB_0XB7011C7E48A9153BC8056F4A27B90E55
IF NOT EXISTS(SELECT TOP 1 1 FROM XQuery WHERE QueryName LIKE 'KBErfolgsrechnung') BEGIN
INSERT INTO XQuery(QueryName, QueryCode) VALUES('KBErfolgsrechnung', 1)
END;

DELETE FROM XQuery WHERE ParentReportName LIKE 'KBErfolgsrechnung';
--SQLCHECK_IGNORE--
UPDATE QRY
SET QueryName =  N'KBErfolgsrechnung' , UserText =  N'KB - Erfolgsrechnung' , QueryCode = 1, LayoutXML =  N'/// <XRTypeInfo>
            ...
            get {
                if (_resources == null) {
                    string resourceString = "zsrvvgEAAACRAAAAbFN5c3RlbS5SZXNvdXJjZXMuUmVzb3VyY2VSZWFkZXIsIG1zY29ybGliLCBWZXJza" +
                        ...
                        "ERUS29udG9Oci5Gb250LCBGb250U3R5bGUuUmVndWxhcik7DQogICB9DQp9AZsEREVDTEFSRSBAS2JQZ" +
                        ...
                        "nVjaHVuZ2VuLCBAT2huZUt0b0dydXBwZW4sIDIgLS1FcmZvbGdzcmVjaG51bmc=";
...
exec spKbGetBilanzErfolg @KbPeriodeID, @DatumVon, @DatumBis, @NurMitBuchungen, @OhneKtoGruppen, 2 --Erfolgsrechnung' , ContextForms =  N'CtlQueryKbBilanzErfolg,CtlQueryKbBilanzErfolg_Erfolg' , ParentReportName =  null , ReportSortKey =  null , System =  0 
FROM XQuery QRY
WHERE QRY.QueryName LIKE  N'KBErfolgsrechnung' ;

...
-- MD5:0XE94411E5295E18F46D43247ACCEC5DA9_0X6EBC4FFD339516FDF5127356C0C3C56B_0X48254D06CBC72655DD5D783C73624ED9
IF NOT EXISTS(SELECT TOP 1 1 FROM XQuery WHERE QueryName LIKE 'KbZUGAbrechnung') BEGIN
INSERT INTO XQuery(QueryName, QueryCode) VALUES('KbZUGAbrechnung', 1)
END;

DELETE FROM XQuery WHERE ParentReportName LIKE 'KbZUGAbrechnung';
UPDATE QRY
SET QueryName =  N'KbZUGAbrechnung' , UserText =  N'KB - ZUG Abrechnung' , QueryCode = 1, LayoutXML =  N'/// <XRTypeInfo>
...
///     <Reference Path="C:\Projects\KiSS4_Migration\KiSS4.DB.dll" />
///     <Reference Path="C:\Projects\KiSS4_Migration\SharpLibrary.dll" />
...
namespace XtraReportSerialization {
    ...
    public class Report : DevExpress.XtraReports.UI.XtraReport {
            ...
            get {
                if (_resources == null) {
                    string resourceString = "zsrvvgEAAACRAAAAbFN5c3RlbS5SZXNvdXJjZXMuUmVzb3VyY2VSZWFkZXIsIG1zY29ybGliLCBWZXJza" +
                        ...
                        "wB0AFMAdABhAHQAZQBtAGUAbgB0AO0LAABAAAEAAAD/////AQAAAAAAAAAMAgAAAFFTeXN0ZW0uRHJhd" +
                        ...
                        "AAASgsAAAJHSUY4OWGNAPUAhwAAAAAAgAAAAIAAgIAAAACAgACAAICAgICAwMDA/wAAAP8A//8AAAD//" +
                        ...
                        "/+Z///M////If8LTkVUU0NBUEUyLjADAQEAACH5BAEAABAALAAAAACNAPUAAAj/AP8JHEiwoMGDCBMqX" +
                        "MiwocOHECNKnEixosWLGDNq3Mixo8ePIEOKHEmypMmTKFOqZIhipUYUMF1ehNlSZsWYMW1KpJlT50Oe/" +
                        "4D6bMiT5lCiQIseXVjU6NKDTVs2fQo1ak+qQaNmnYp1q9WaVL96VRpWKdenYseSPXr27NCvNZOu1elWL" +
                        "Vu4AuFedVk371y+U4Wa7ZuSsF2ZWskqNlySMWOSWsf6daoWbGGhCR+HjCy582TKKP9WxXySs2fSh0OjR" +
                        "qjZY13Sf0WPbJ26sWjYqGWL1G2Q9sa+uEF/tgx5dWbjm40H3+vZtnCFvD/KXk68efHnx5nPVg56Ovbd3" +
                        "3sj/0+Onfro6tvDE4zu+rb5gr4z0jYNfvVc9/En4oWetv7z+/ZZJZ1eTO3XnoDrvTcQgfyxp1d4D6KXo" +
                        "GYMLqigeIZViGF+E/KmYYfqAaheZRv2B6J2OxEW4XkoWtjdeC4KFyFzHDb434zwsdecjjtyheBwEt4ko" +
                        "mCvwRijZTwOSSN1QVLkFn6UzXdhdlFy96KRKU453JFNHgmiQ2t5hxmPWfak4phJaskamuWFiaV+bLZZ5" +
                        "ZtKghknem29WSaSVpqZ5pUt5jjnjYB26aSWedKpZokn8snkgVcVeaehPY64ZaM/AtnRkzM6ammlgWoq6" +
                        "Ic1Fkjoh7WtWShLYprI5W+tZv/6qqmRGumYq1xSyqpuBpYYaJ2qeohrrmtayCKEw+ZKXFwKrhisrJjS1" +
                        "ymV0Crr5qrWtujss67iSK2oxyZaa6EwRvbYg+EKu1h0JgI7K7XjllttZaGaRp+vnuaL716yzguktvcqO" +
                        "2qsMqrZKcGTOpgWugMfXJ27DTPMrbe7OoyixdpBHHGy0XKcLqr7JqtxyJ9mS+bGAU+c8qUsVzyTvz/1C" +
                        "hHMXtbc1c12Yovzzjbqy/PPLH4J9NA2W0c0zyMfjXPSSnfFdNNl6Qz10otOvdTTVr/FJMZcd+3112DHG" +
                        "/bYZJdNdsdmp6322kqy7fbbaaMN99x0T5v13XjnrffefPcc7bdKdQcuuMNyD2544IUfrvjbiS/ueNwmP" +
                        "y652f9CD1gq1Fhj5LHemWu++d2dy0dz1qGLPjrmVVt++c6lw3o60a1zJLPVscv+OdC1b3o766k7tzLuv" +
                        "Zs0+9C5gzT8z8WvZ/vrVwfvoqCu/45V6acuvzrgzgeoJ1LM2xS69idXHD5gUlNJ8ku7ky92ziT7KaT03" +
                        "js/GcrHiz++8PLP33hs8sKPffm7op+Bfle/leSuYBgjUc/uR571Zel8//JfAUuTv1GhLHKhypZPkqc/T" +
                        "EVwfOkzXgVH0z6J5cx/IgQgnJb1tYiE0Ho+81y+uObCF5rOgTdJEAYpdkIGWoSDflHeB2kYs+69TIUzO" +
                        "9XZini9JCKRiX5SmxOb2MPKva//bjVE4RVj+MPBTdGHVSwaS+AFtz1tL4s4tBMZ13YoLX7RipnRocqk2" +
                        "EYqDgyOx8kLrRhXRzAGTYy9MVYP3bbFM/YMj+LR44L2SMg+GvJZiFRkVjpkP7YVsmTfAuTzuLhGOq7we" +
                        "ljj18mw+MnLMS0u1vqiJR2JSSvyaoaGpNslWwmqIIEFZIxcZSnP2DkTQrGRu9RT5rZlqh2ObZaUGiYuP" +
                        "zhET5rRVsFD1ba8yMpfRXM/FmsmG6t5sexRTpvbDGbGvFk2Y0JOnKJ8ogATSC9SovOW+fvm45DJLHWW8" +
                        "GDgLCM9a7fEdgpun/b8GOHyObcu9up+xySoLLmZxl+y05+H1DMop2hpzh9NbnWZ8iNEB3hRP040g6rka" +
                        "EfBCMRKDmqkFG2ZRtFYUcXtKZL4Q6kRS3pEmXKIphK1afjahhidurFtuoIUDw33xlTesIP7g2VBodgx1" +
                        "bGQh+2850C5JzY3UrWq3Vpm2JiKwSNGkKDrXBLYuApWIX11o2L1ZUKv+qUJDtIoxKxoS5nnLrdaEK0is" +
                        "xtebVjLptZQoRnSawtfCki7ClSrgvVaKRFpWKcQsZPiemhRW0Y/WgE2g4nt2mI1qUGH+nKO13rsZI0Ws" +
                        "gZd1rM+Uixh/ykL2jzuFaQ7vCwDW3c7vaKWSJpdLWkhG8x3RlGyZN3tAlN6w4XlFo2cfCtxa2rR4waXp" +
                        "EZEHzadG0bWhnS5qhKkNucKW1c+srQNjBx3dbtSf6YwJxIT7VWTi0zTESu92VQlTN/pVdkmtbvgEm57o" +
                        "2fb1+LXOuWFIJzmGlYQ5ua7631kwkA21erGyD9NjK9U8QscBCuXwr+Na1J/yaj0oPCkn90fh+94HasCN" +
                        "pd07VNQZSg9ELu1v/CCZEwJmOFlJm6QMqZgikMM2pIFFrsMLSRyPzweOz4TyAxNJrsszNwAD1lR/fuv7" +
                        "kx85NMpjMksNvKEQdoaJ++Xvxrmlvi0Fv/dHmvxT0iWLhWBG2O23qXMG3YwI9EC5xvjOLhktipWd8pnL" +
                        "DuVlw9L3029DGZFBVFgI5av00bHrKCQ+M5PvpldcfLUITuSd/BDpaOFzEpMS/DQu8zpitXnoCBKec2E/" +
                        "jOWGh3SLEvZgK8bdaouCbw6t7m4rya1nxsFw1zD2tYnEqqv/0flhp03zToutgKFPWxil0rZCZY1XUIIb" +
                        "eUqrbFaRnHTJgjs626bY91+srQ3iKtwHxl1/TG3OKeGF3VXk934JHe1e8rjX2dbNYbFd6pnvG8197uB/" +
                        "/b3rn13b4AP/NgBVzWye51wgzc82gunt7vFHfFp23jKfK31xZNc8UUix/u6G+fbRf92YX2SnOLnPHmTx" +
                        "6pyCIe55TCPucxnTpWAAAA7CwGCCy0tIGluaXQgdmFyDQpERUNMQVJFIEBLYldWRWluemVscG9zdGVuS" +
                        "URzIFZBUkNIQVIoTUFYKQ0KREVDTEFSRSBATGFuZ3VhZ2VDb2RlIElOVA0KREVDTEFSRSBASGVhZGVyR" +
                        "GF0dW1Wb24gREFURVRJTUUNCkRFQ0xBUkUgQEhlYWRlckRhdHVtQmlzIERBVEVUSU1FDQoNClNFVCBAS" +
                        "2JXVkVpbnplbHBvc3RlbklEcyA9IG51bGwNClNFVCBATGFuZ3VhZ2VDb2RlID0gbnVsbA0KU0VUIEBIZ" +
                        "WFkZXJEYXR1bVZvbiA9IG51bGwNClNFVCBASGVhZGVyRGF0dW1CaXMgPSBudWxsDQoNCi0tIGdldCBkY" +
                        "XRhIHVzaW5nIGRiIGZ1bmN0aW9uDQpTRUxFQ1QgRkNOLklkJCwNCiAgICAgICBGQ04uRmFMZWlzdHVuZ" +
                        "0lELA0KICAgICAgIEZDTi5CYVBlcnNvbklELA0KICAgICAgIEZDTi5Lb3N0ZW5zdGVsbGVOciwNCiAgI" +
                        "CAgICBIZWFkZXJfRGF0dW1Wb24gPSBJU05VTEwoQ09OVkVSVChWQVJDSEFSLCBASGVhZGVyRGF0dW1Wb" +
                        "24sIDEwNCksICc/JyksDQogICAgICAgSGVhZGVyX0RhdHVtQmlzID0gSVNOVUxMKENPTlZFUlQoVkFSQ" +
                        "0hBUiwgQEhlYWRlckRhdHVtQmlzLCAxMDQpLCAnPycpLA0KICAgICAgIEZDTi5IZWFkZXJfUGVyc29uT" +
                        "mFtZSwNCiAgICAgICBGQ04uSGVhZGVyX1BlcnNvbkdlYnVydHNkYXR1bSwNCiAgICAgICBGQ04uSGVhZ" +
                        "GVyX0hlaW1hdGdlbWVpbmRlbiwNCiAgICAgICBGQ04uSGVhZGVyX0thbnRvbmUsDQogICAgICAgRkNOL" +
                        "khlYWRlcl9Xb2hub3J0LA0KICAgICAgIEZDTi5IZWFkZXJfV29obmthbnRvbk5yLA0KICAgICAgIEZDT" +
                        "i5IZWFkZXJfSGVpbWF0a2FudG9uTnIsDQogICAgICAgRkNOLkhlYWRlcl9CZW1lcmt1bmcsDQogICAgI" +
                        "CAgRkNOLlN1Yl9CZXRyYWcxLA0KICAgICAgIEZDTi5TdWJfQmV0cmFnMiwNCiAgICAgICBGQ04uU3ViX" +
                        "0JldHJhZzMsDQogICAgICAgRkNOLlN1Yl9CZXRyYWc0LA0KICAgICAgIEZDTi5TdWJfQmV0cmFnNSwNC" +
                        "iAgICAgICBGQ04uU3ViX0JldHJhZzVhLA0KICAgICAgIEZDTi5TdWJfQmV0cmFnNWIsDQogICAgICAgR" +
                        "kNOLlN1Yl9CZXRyYWc1YywNCiAgICAgICBGQ04uU3ViX0JldHJhZzYsDQogICAgICAgRkNOLlN1Yl9Ub" +
                        "3RhbEF1c2dhYmVuLA0KICAgICAgIEZDTi5TdWJfQmV0cmFnOCwNCiAgICAgICBGQ04uU3ViX0JldHJhZ" +
                        "zhhLA0KICAgICAgIEZDTi5TdWJfQmV0cmFnOSwNCiAgICAgICBGQ04uU3ViX0JldHJhZzEwLA0KICAgI" +
                        "CAgIEZDTi5TdWJfQmV0cmFnMTEsDQogICAgICAgRkNOLlN1Yl9Ub3RhbEVpbm5haG1lbiwNCiAgICAgI" +
                        "CBGQ04uU3ViX0JldHJhZzE0LA0KICAgICAgIEZDTi5TdWJfQmV0cmFnMTVUb3RhbA0KRlJPTSBkYm8uZ" +
                        "m5LYkdldFdWUmVwb3J0RGF0YShAS2JXVkVpbnplbHBvc3RlbklEcywgQExhbmd1YWdlQ29kZSkgRkNOD" +
                        "QpPUkRFUiBCWSBGQ04uSGVhZGVyX1BlcnNvbk5hbWUsIEZDTi5Lb3N0ZW5zdGVsbGVOcg==";
        ...
        private void InitializeComponent() {
            ...
            this.xrTableCell20.Size = new System.Drawing.Size(1140, 80);
            ...
            this.xrTableCell21.Location = new System.Drawing.Point(1140, 0);
            ...
            this.xrTableCell21.Size = new System.Drawing.Size(452, 80);
            this.xrTableCell21.Text = "Sozialdienst Münchenbuchsee";
            // 
            // xrPageInfo1
            // 
            ...
            this.xrPageInfo1.Format = "Münchenbuchsee, {0:dd.MM.yyyy}";
            this.xrPageInfo1.Location = new System.Drawing.Point(0, 0);
            this.xrPageInfo1.Name = "xrPageInfo1";
            this.xrPageInfo1.Padding = new DevExpress.XtraPrinting.PaddingInfo(5, 5, 0, 0, 254F);
            this.xrPageInfo1.PageInfo = DevExpress.XtraPrinting.PageInfo.DateTime;
            this.xrPageInfo1.ParentStyleUsing.UseFont = false;
            this.xrPageInfo1.Size = new System.Drawing.Size(1140, 80);
            // 
            // xrTableRow26
            // 
...
</NewDataSet>' , SQLquery =  N'-- init var
...
ORDER BY FCN.Header_PersonName, FCN.KostenstelleNr' , ContextForms =  N'KbZUGAbrechnung' , ParentReportName =  null , ReportSortKey =  null 
FROM XQuery QRY
WHERE QRY.QueryName LIKE  N'KbZUGAbrechnung' ;

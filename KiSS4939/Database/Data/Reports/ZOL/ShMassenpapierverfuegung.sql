...
WHERE BBG.BgBudgetID = @BgBudgetID
  AND BBG.BgBewilligungStatusCode = 5' , ContextForms =  N'CtlQueryShPapierverfuegung' , ParentReportName =  null , ReportSortKey =  null 
FROM XQuery QRY
...
set @BudgetJahr           = (SELECT Jahr  FROM BgBudget WHERE BgBudgetID = @BgBudgetID)
  ...
  ORDER BY IdGroup, FBL.KbBuchungID' ,  null ,  N'ShMassenpapierverfuegung' ,  null );

...
{
    public class DlgWhFinanzplanVisieren : KiSS4.Gui.KissDialog
    {
        #region Fields
        ...
        public DlgWhFinanzplanVisieren(int BgFinanzplanID)
            : this()
        {
            SqlQuery qry = DBUtil.OpenSQL(@"
                ...
                where BEW.BgFinanzplanID = {0}
                and BEW.BgPositionID is NULL
                and BEW.BgBewilligungCode = 1",
                BgFinanzplanID);

            Datum = DateTime.Now;

            qryBgBewilligung.Fill("SELECT TOP 0 Anfragender = '', * FROM BgBewilligung");
            ...
            if (qry.Count > 0)
            {
                qryBgBewilligung["Anfragender"] = qry["Anfragender"];
                edtSender.EditValue = qry["Anfragender"].ToString();
                qryBgBewilligung["UserID_An"] = qry["UserIDAn"];
            }
        }

        public DlgWhFinanzplanVisieren()
        {
        ...
        private void InitializeComponent()
        {
            ...
            this.edtMitteilung.DataSource = this.qryBgBewilligung;
            ...
            this.qryBgBewilligung.SelectStatement = "SELECT Anfragender = \'\',\r\n*\r\nFROM BgBewilligung BEW";
            ...
            this.edtSender.DataSource = this.qryBgBewilligung;
            ...
            this.Name = "DlgWhFinanzplanVisieren";
            this.Text = "Visieren";
        ...
        private void btnAblehnen_Click(object sender, System.EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                this.btnAbbrechen_Click(sender, e);
            }
        }

...
{
    public class CtlBgSilSituationsbedingteLeistungen : KiSS4.Gui.KissUserControl
    {
        #region Fields
        ...
        const LOV.BgGruppeCode BgGruppeCode = LOV.BgGruppeCode.Situationsbedingte_Leistungen;
        ...
        public CtlBgSilSituationsbedingteLeistungen(Image titelImage, string titelText, int bgBudgetID)
            : this()
        {
        ...
        public CtlBgSilSituationsbedingteLeistungen()
        {
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(CtlBgSilSituationsbedingteLeistungen));
            ...
            // 
            // CtlBgSilSituationsbedingteLeistungen
            // 
            ...
            this.Name = "CtlBgSilSituationsbedingteLeistungen";
                    ...
                    qryBgPosition["BgBudgetID"], qryBgPosition["BgPositionID"]))
            {
                throw new KissInfoException(
                    KissMsg.GetMLMessage(
                        "CtlBgSilSituationsbedingteLeistungen", "NichtLoeschen",
        ...
        private void qryBgPosition_BeforePost(object sender, System.EventArgs e)
        {
            ...
            if (!DBUtil.IsEmpty(edtDatumVon.EditValue))
            {
                ...
                {
                    throw new KissInfoException(KissMsg.GetMLMessage("CtlBgSilSituationsbedingteLeistungen", "GeplantInnerhFinanzpl", "Geplant von muss innherhalb von Zeitspanne des Finanzplanes liegen ({0:d} - {1:d}).", KissMsgCode.MsgInfo, qryBgFinanzplan["FinanzPlanVon"], qryBgFinanzplan["FinanzPlanBis"]));
                }
                ...
                if (!DBUtil.IsEmpty(edtDatumBis.EditValue))
                {
                    ...
                    {
                        throw new KissInfoException(KissMsg.GetMLMessage("CtlBgSilSituationsbedingteLeistungen", "GeplantVonZuGross", "Geplant von muss kleiner sein als geplant bis."));
                    }
                }
            }

...
{
    public class CtlBgSilKrankheitBehinderungLeistung : KiSS4.Gui.KissUserControl
    {
        #region Fields
        ...
        const LOV.BgGruppeCode BgGruppeCode = LOV.BgGruppeCode.Krankheits_und_behinderunsbedingte_Leistungen; 
        ...
        public CtlBgSilKrankheitBehinderungLeistung(Image titelImage, string titelText, int bgBudgetID)
            : this()
        {
        ...
        public CtlBgSilKrankheitBehinderungLeistung()
        {
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(CtlBgSilKrankheitBehinderungLeistung));
            ...
            // 
            // CtlBgSilKrankheitBehinderungLeistung
            // 
            ...
            this.Name = "CtlBgSilKrankheitBehinderungLeistung";
                    ...
                    qryBgPosition["BgBudgetID"], qryBgPosition["BgPositionID"]))
            {
                throw new KissInfoException(
                    KissMsg.GetMLMessage(
                        "CtlBgSilKrankheitBehinderungLeistung", "NichtLoeschen",
        ...
        private void qryBgPosition_BeforePost(object sender, System.EventArgs e)
        {
            ...
            if (!DBUtil.IsEmpty(edtDatumVon.EditValue))
            {
                ...
                {
                    throw new KissInfoException(KissMsg.GetMLMessage("CtlBgSilKrankheitBehinderungLeistung", "GeplantInnerhFinanzpl", "Geplant von muss innherhalb von Zeitspanne des Finanzplanes liegen ({0:d} - {1:d}).", KissMsgCode.MsgInfo, qryBgFinanzplan["FinanzPlanVon"], qryBgFinanzplan["FinanzPlanBis"]));
                }
                ...
                if (!DBUtil.IsEmpty(edtDatumBis.EditValue))
                {
                    ...
                    {
                        throw new KissInfoException(KissMsg.GetMLMessage("CtlBgSilKrankheitBehinderungLeistung", "GeplantVonZuGross", "Geplant von muss kleiner sein als geplant bis."));
                    }
                }
            }

...
{
    [TestClass]
    public class FaKategorisierungRepositoryTest
    {
        ...
        //[TestMethod]
        //public void TestSaveOverlappingPeriods()
        //{
        //    // Act
        //    BaPerson person = null;
        //    using (var uow = new KissUnitOfWork())
        //    {
        //        // ToDo
        //        //person = uow.FaKategorisierung. GetById(_testHelper.Person.BaPersonID);
        //    }
        ...
        //    using (var context = new KissContext())
        //    {
        //        var person = context.BaPerson.Add(new BaPerson { Name = "Kissinger", Vorname = "Henry" });
        //        context.SaveChanges();
        //        baPersonID = person.BaPersonID;
        //    }
        ...
        //    using (var uow = new KissUnitOfWork())
        //    {
        //        uow.BaPerson.Remove(baPersonID);
        //        uow.SaveChanges();
        //    }
        ...
        //    {
        //        person = uowGet.BaPerson.GetById(baPersonID);
        //    }
        //    var originalName = person.Name;
        //    person.Name = originalName + " test";
        //    person.Name = originalName;
        ...
        //    {
        //        uowOtherUser.BaPerson.Remove(baPersonID);

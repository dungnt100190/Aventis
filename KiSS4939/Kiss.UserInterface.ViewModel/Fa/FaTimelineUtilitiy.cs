...
namespace Kiss.UserInterface.ViewModel.Fa
{
    ...
    public class FaTimelineUtility
    {
        ...
        public FaTimelineUtility(FaTimelineVM model, double viewPortWidth)
        {
            ...
            if (model != null)
            {
                foreach (var axis in model.Swimlanes)
                {
        ...
        ///// false: space is free
        ///// </returns>
        //public bool IsOverlapping(FaTimelineSwimlaneVM swimlane, FaTimelinePeriodDTO timelinePeriod)
        //{

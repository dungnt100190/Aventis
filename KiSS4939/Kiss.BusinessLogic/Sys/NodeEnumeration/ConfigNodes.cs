...
namespace Kiss.BusinessLogic.Sys.NodeEnumeration
{
    public static class ConfigNodes
    {
        ...
        public static readonly ConfigNode<bool> System_Fallfuehrung_LogischesLoeschen =
                                                                            new ConfigNode<bool>(@"System\Fallfuehrung\LogischesLoeschen");
        ...
        public static readonly ConfigNode<string> System_Fibu_SaldoGruppeName_Betriebskonto =
            new ConfigNode<string>(@"System_Fibu_SaldoGruppeName_Betriebskonto");

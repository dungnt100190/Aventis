...
{
    public class CtlQueryMigProleistWVTraeger : KiSS4.Common.KissQueryControl
    {
        #region Fields
        ...
        public CtlQueryMigProleistWVTraeger()
        {
            ...
            qryDat = DBUtil.OpenSQL(@"
                ...
                if (!DBUtil.UserHasRight("CtlQueryMigProleistWVTraeger_AuswahlGruppe"))
                    edtSucheGruppe.EditMode = EditModeType.ReadOnly;

                if (!DBUtil.UserHasRight("CtlQueryMigProleistWVTraeger_AuswahlTeam"))
                    edtSucheTeam.EditMode = EditModeType.ReadOnly;

            edtWVCode.SetLookupDataSource( DBUtil.OpenSQL(@"
                SELECT Code = ShortText, Text = ShortText --+ IsNull( ' (' + Text + ')','')
                FROM XLOVCode
            ...
            edtWVCode.EditValue = "Z-N,K-F,K-N,A-N,R-F";
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(CtlQueryMigProleistWVTraeger));
            ...
            // ctlGotoFall
            //
            this.ctlGotoFall.Location = new System.Drawing.Point(109, 397);
            this.ctlGotoFall.Size = new System.Drawing.Size(116, 24);
            //
            // tpgListe
            //
            ...
            this.btnCompare.Location = new System.Drawing.Point(3, 397);
            this.btnCompare.Name = "btnCompare";
            this.btnCompare.Size = new System.Drawing.Size(100, 24);
            this.btnCompare.TabIndex = 3;
            this.btnCompare.Text = "KiSS-Daten";
            ...
            this.edtKlientensystem.Location = new System.Drawing.Point(345, 397);
            ...
            this.edtKlientensystem.TabIndex = 16;
            ...
            // edtSucheGruppe
            //
            this.edtSucheGruppe.Location = new System.Drawing.Point(122, 38);
            ...
            // edtSucheTeam
            //
            this.edtSucheTeam.Location = new System.Drawing.Point(122, 68);
            ...
            // edtUserID
            //
            this.edtUserID.Location = new System.Drawing.Point(122, 98);
            ...
            // edtSucheKlient
            //
            this.edtSucheKlient.Location = new System.Drawing.Point(122, 128);
            ...
            // lblWhSucheKlientX
            //
            this.lblWhSucheKlientX.Location = new System.Drawing.Point(3, 128);
            ...
            // lblSucheOE
            //
            this.lblSucheOE.Location = new System.Drawing.Point(3, 38);
            ...
            this.lblSucheOE.Visible = false;
            //
            // lblSucheTeam
            //
            this.lblSucheTeam.Location = new System.Drawing.Point(3, 68);
            ...
            this.lblSucheTeam.Visible = false;
            //
            // lblUserID
            //
            this.lblUserID.Location = new System.Drawing.Point(3, 98);
            ...
            this.edtBED.Location = new System.Drawing.Point(506, 160);
            this.edtBED.Name = "edtBED";
            this.edtBED.Size = new System.Drawing.Size(263, 258);
            this.edtBED.TabIndex = 333;
            //
            // edtWVCode
            //
            ...
            this.edtWVCode.Location = new System.Drawing.Point(122, 160);
            this.edtWVCode.Name = "edtWVCode";
            this.edtWVCode.Size = new System.Drawing.Size(338, 258);
            this.edtWVCode.TabIndex = 334;
            //
            // colBaPersonID
            //
            ...
            //
            // CtlQueryMigProleistWVTraeger
            //
            this.Name = "CtlQueryMigProleistWVTraeger";
        ...
        protected override void NewSearch()
        {
            ...
            try
            {
                ...
                if (!DBUtil.UserHasRight("CtlQueryMigProleistWVTraeger_AuswahlGruppe") &&
                    !DBUtil.UserHasRight("CtlQueryMigProleistWVTraeger_AuswahlTeam"))
                {
        ...
        private void btnCompare_Click(object sender, System.EventArgs e)
        {
            ...
            dlg.SearchData(@"
              SELECT Von = DatumVon, Bis = DatumBis, [WV-Traeger] = CASE WHEN WVM.BaPersonID = WVE.BaPersonID THEN 'ja' ELSE 'nein' END, Code = dbo.fnLOVShortText('BaWVCode',WVE.WVCode), BED = BEDCode
              FROM WhWVEinheit                 WVE
                INNER JOIN WhWVEinheitMitglied WVM ON WVE.WhWVEinheitID = WVM.WhWVEinheitID
              WHERE WVM.BaPersonID = {0}
              ORDER BY DatumVon",
        ...
        private void edtUserID_UserModifiedFld(object sender, KiSS4.Gui.UserModifiedFldEventArgs e)
        {
            ...
            edtUserID.EditValue  = dlg["Kürzel"].ToString();
            }
        }

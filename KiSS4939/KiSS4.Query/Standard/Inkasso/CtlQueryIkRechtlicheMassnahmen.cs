...
{
    public class CtlQueryIkRechtlicheMassnahmen : KiSS4.Common.KissQueryControl
    {
        #region Fields
        ...
        public CtlQueryIkRechtlicheMassnahmen()
        {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(CtlQueryIkRechtlicheMassnahmen));
            ...
            // edtVariante
            //
            this.edtVariante.AllowNull = false;
            ...
            this.edtVariante.Size = new System.Drawing.Size(260, 24);
            this.edtVariante.TabIndex = 4;
            //
            // lblSAR
            //
            ...
            //
            // CtlQueryIkRechtlicheMassnahmen
            //
            this.Name = "CtlQueryIkRechtlicheMassnahmen";
            this.Load += new System.EventHandler(this.CtlQueryIkRechtlicheMassnahmen_Load);
        ...
        private void CtlQueryIkRechtlicheMassnahmen_Load(object sender, System.EventArgs e)
        {
            edtVariante.LoadQuery(DBUtil.OpenSQL(@"
                    SELECT Code = 1, Text = 'laufende rechtliche Massnahmen'
                    UNION
                    SELECT Code = 2, Text = 'neu eroeffnete rechtliche Massnahmen'
                    UNION
                    SELECT Code = 3, Text = 'abgeschlossene rechtliche Massnahmen'
                "));

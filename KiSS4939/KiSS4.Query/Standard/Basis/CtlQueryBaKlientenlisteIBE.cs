...
namespace KiSS4.Query
{
    public partial class CtlQueryBaKlientenlisteIBE : KissQueryControl
    {
        ...
        protected override void NewSearch()
        {
            ...
            // Try to select the OrgUnit (OrgUnitMemberCode 2) from session
            // When OrgUnit is not available, no exception occurs
            edtOrgUnitID.EditValue = Session.User.OrgUnitID;
            base.NewSearch();
        }

...
{
    public class CtlQueryShStatusMonatsbudgets : KissQueryControl
    {
        #region Fields
        ...
        public CtlQueryShStatusMonatsbudgets()
        {
            InitializeComponent();
            ...
            qry = DBUtil.OpenSQL(@"select Code = 1, Text = 'in Vorbereitung (grau)'
            union all
            ...
            edtStatus.Properties.Columns.AddRange(
                new[]
                {
                    new LookUpColumnInfo("Text", "", 75, FormatType.None, "", true, HorzAlignment.Default)
                });
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(CtlQueryShStatusMonatsbudgets));
            ...
            //
            // CtlQueryShStatusMonatsbudgets
            //
            this.Name = "CtlQueryShStatusMonatsbudgets";

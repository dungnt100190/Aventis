...
{
    public class CtlQueryShStatusMonatsbudgetsZulagen : KissQueryControl
    {
        #region Fields
        ...
        private KiSS4.Gui.KissLookUpEdit edtZulage;
        ...
        private KiSS4.Gui.KissLabel lblZulage;

        #endregion

        #region Constructors

        public CtlQueryShStatusMonatsbudgetsZulagen()
        {
            InitializeComponent();

            SqlQuery qry = DBUtil.OpenSQL(@"
                select Code = OrgUnitID, Text = ItemName from XOrgUnit
                where ModulID = 3
                order by ItemName");
            ...
            qry = DBUtil.OpenSQL(@"
                select Code = 1, Text = 'in Vorbereitung (grau)'
                union all
                select Code = 5, Text = 'ausgeloest (gruen)'
                union all
                select Code = 9, Text = 'gesperrt (rot)'");
            ...
            edtStatus.Properties.Columns.AddRange(new[]
                {
                    new LookUpColumnInfo("Text", "", 75, FormatType.None, "", true, HorzAlignment.Default)
                });
            ...
            qry = DBUtil.OpenSQL(@"
                SELECT 1 AS Code, 'EFB' AS Text, 1 AS SortKey
                UNION ALL
                SELECT 2 AS Code, 'IZU' AS Text, 2 AS SortKey
                UNION ALL
                SELECT 3 AS Code, 'MIZ' AS Text, 3 AS SortKey");

            newRow = qry.DataTable.NewRow();
            newRow["Text"] = "";
            qry.DataTable.Rows.InsertAt(newRow, 0);
            newRow.AcceptChanges();
            edtZulage.Properties.Columns.Clear();
            edtZulage.Properties.Columns.AddRange(new[]
                {
                    new LookUpColumnInfo("Text", "", 75, FormatType.None, "", true, HorzAlignment.Default)
                });
            edtZulage.Properties.ShowFooter = false;
            edtZulage.Properties.ShowHeader = false;
            edtZulage.Properties.DisplayMember = "Text";
            edtZulage.Properties.ValueMember = "Code";
            edtZulage.Properties.DropDownRows = Math.Min(qry.Count, 7);
            edtZulage.Properties.DataSource = qry;
        }
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(CtlQueryShStatusMonatsbudgetsZulagen));
            ...
            this.lblZulage = new KiSS4.Gui.KissLabel();
            ...
            this.edtZulage = new KiSS4.Gui.KissLookUpEdit();
            ...
            ((System.ComponentModel.ISupportInitialize)(this.lblZulage)).BeginInit();
            ...
            ((System.ComponentModel.ISupportInitialize)(this.edtZulage)).BeginInit();
            ((System.ComponentModel.ISupportInitialize)(this.edtZulage.Properties)).BeginInit();
            ...
            this.ctlGotoFall.Size = new System.Drawing.Size(155, 24);
            //
            // tpgListe
            //
            ...
            // tpgSuchen
            //
            this.tpgSuchen.Controls.Add(this.edtZulage);
            ...
            this.tpgSuchen.Controls.Add(this.lblZulage);
            ...
            this.tpgSuchen.Controls.SetChildIndex(this.lblZulage, 0);
            ...
            this.tpgSuchen.Controls.SetChildIndex(this.edtZulage, 0);
            //
            // lblSektion
            //
            ...
            // lblDatumbereich
            //
            this.lblDatumbereich.Location = new System.Drawing.Point(10, 130);
            ...
            // lblZulage
            //
            this.lblZulage.Location = new System.Drawing.Point(10, 190);
            this.lblZulage.Name = "lblZulage";
            this.lblZulage.Size = new System.Drawing.Size(130, 24);
            this.lblZulage.TabIndex = 7;
            this.lblZulage.Text = "Zulage";
            this.lblZulage.UseCompatibleTextRendering = true;
            //
            // edtOrgUnitID
            //
            ...
            // edtStatus
            //
            this.edtStatus.Location = new System.Drawing.Point(150, 160);
            ...
            this.edtStatus.Size = new System.Drawing.Size(220, 24);
            this.edtStatus.TabIndex = 25;
            //
            // edtZulage
            //
            this.edtZulage.Location = new System.Drawing.Point(150, 190);
            this.edtZulage.Name = "edtZulage";
            this.edtZulage.Properties.Appearance.BackColor = System.Drawing.Color.AliceBlue;
            this.edtZulage.Properties.Appearance.BorderColor = System.Drawing.Color.Linen;
            this.edtZulage.Properties.Appearance.Font = new System.Drawing.Font("Arial", 13F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Pixel);
            this.edtZulage.Properties.Appearance.Options.UseBackColor = true;
            this.edtZulage.Properties.Appearance.Options.UseBorderColor = true;
            this.edtZulage.Properties.Appearance.Options.UseFont = true;
            this.edtZulage.Properties.BorderStyle = DevExpress.XtraEditors.Controls.BorderStyles.HotFlat;
            this.edtZulage.Properties.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {
                        new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
            this.edtZulage.Properties.ButtonsStyle = DevExpress.XtraEditors.Controls.BorderStyles.UltraFlat;
            this.edtZulage.Properties.NullText = "";
            this.edtZulage.Properties.ShowFooter = false;
            this.edtZulage.Properties.ShowHeader = false;
            this.edtZulage.Size = new System.Drawing.Size(220, 24);
            this.edtZulage.TabIndex = 26;
            //
            // colMonatsbudget
            //
            ...
            //
            // CtlQueryShStatusMonatsbudgetsZulagen
            //
            this.Name = "CtlQueryShStatusMonatsbudgetsZulagen";
            ...
            ((System.ComponentModel.ISupportInitialize)(this.lblZulage)).EndInit();
            ...
            ((System.ComponentModel.ISupportInitialize)(this.edtZulage.Properties)).EndInit();
            ((System.ComponentModel.ISupportInitialize)(this.edtZulage)).EndInit();

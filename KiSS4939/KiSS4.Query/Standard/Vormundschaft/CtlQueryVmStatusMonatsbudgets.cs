...
{
    public class CtlQueryVmStatusMonatsbudgets : KissQueryControl
    {
        #region Fields
        ...
        public CtlQueryVmStatusMonatsbudgets()
        {
            InitializeComponent();
            ...
            SqlQuery qryStatus = DBUtil.OpenSQL(@"select Code = 1, Text = 'in Vorbereitung (grau)'
                union all
                select 5, 'ausgelöst (grün)'
                union all
                select 9, 'gesperrt (rot)'
            order by 1");
            System.Data.DataRow newRowStatus = qryStatus.DataTable.NewRow();
            newRowStatus["Text"] = "";
            qryStatus.DataTable.Rows.InsertAt(newRowStatus, 0);
            newRowStatus.AcceptChanges();
            ...
            edtStatus.Properties.DataSource = qryStatus;
        }
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(CtlQueryVmStatusMonatsbudgets));
            ...
            //
            // CtlQueryVmStatusMonatsbudgets
            //
            this.Name = "CtlQueryVmStatusMonatsbudgets";

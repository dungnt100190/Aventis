...
{
    public class CtlAdEinsatzRegionVerwaltung : KiSS4.Common.KissSearchUserControl
    {
        ...
        private KiSS4.DB.SqlQuery qryEdEinsatzRegion;

        #endregion

        #region Constructors

        public CtlAdEinsatzRegionVerwaltung()
        {
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(CtlAdEinsatzRegionVerwaltung));
            ...
            this.qryEdEinsatzRegion = new KiSS4.DB.SqlQuery(this.components);
            ...
            ((System.ComponentModel.ISupportInitialize)(this.qryEdEinsatzRegion)).BeginInit();
            this.SuspendLayout();
            //
            // searchTitle
            //
            ...
            // grdEdKurs
            //
            this.grdEdKurs.DataSource = this.qryEdEinsatzRegion;
            ...
            this.edtBezeichnung.DataSource = this.qryEdEinsatzRegion;
            ...
            this.edtKGS.DataSource = this.qryEdEinsatzRegion;
            ...
            this.chkAktiv.DataSource = this.qryEdEinsatzRegion;
            ...
            this.edtBemerkungen.DataSource = this.qryEdEinsatzRegion;
            ...
            // qryEdEinsatzRegion
            //
            this.qryEdEinsatzRegion.HostControl = this;
            this.qryEdEinsatzRegion.SelectStatement = resources.GetString("qryEdEinsatzRegion.SelectStatement");
            this.qryEdEinsatzRegion.TableName = "EdEinsatzRegion";
            this.qryEdEinsatzRegion.BeforePost += new System.EventHandler(this.qryEdEinsatzRegion_BeforePost);
            this.qryEdEinsatzRegion.AfterFill += new System.EventHandler(this.qryEdEinsatzRegion_AfterFill);
            this.qryEdEinsatzRegion.AfterInsert += new System.EventHandler(this.qryEdEinsatzRegion_AfterInsert);
            this.qryEdEinsatzRegion.BeforeDeleteQuestion += new System.EventHandler(this.qryEdEinsatzRegion_BeforeDeleteQuestion);
            this.qryEdEinsatzRegion.AfterPost += new System.EventHandler(this.qryEdEinsatzRegion_AfterPost);
            //
            // CtlAdEinsatzRegionVerwaltung
            //
            this.ActiveSQLQuery = this.qryEdEinsatzRegion;
            this.Controls.Add(this.panDetails);
            this.Name = "CtlAdEinsatzRegionVerwaltung";
            this.Size = new System.Drawing.Size(792, 569);
            this.Load += new System.EventHandler(this.CtlAdEinsatzRegionVerwaltung_Load);
            ...
            ((System.ComponentModel.ISupportInitialize)(this.qryEdEinsatzRegion)).EndInit();
        ...
        private void CtlAdEinsatzRegionVerwaltung_Load(object sender, System.EventArgs e)
        {
        ...
        private void SetupRights()
        {
            ...
            qryEdEinsatzRegion.CanInsert = isAdmin || canInsert;
            qryEdEinsatzRegion.CanUpdate = isAdmin || canUpdate;
            qryEdEinsatzRegion.CanDelete = isAdmin || canDelete;

            // FIELDS
            qryEdEinsatzRegion.EnableBoundFields();
        }

        private void qryEdEinsatzRegion_AfterFill(object sender, System.EventArgs e)
        {
            // select last row
            qryEdEinsatzRegion.Last();
        }

        private void qryEdEinsatzRegion_AfterInsert(object sender, System.EventArgs e)
        {
            // set default value
            qryEdEinsatzRegion["Aktiv"] = 1;

            // creator of row (if changed)
            qryEdEinsatzRegion["Creator"] = DBUtil.GetDBRowCreatorModifier();

            // set focus
            edtBezeichnung.Focus();
        }

        private void qryEdEinsatzRegion_AfterPost(object sender, System.EventArgs e)
        {
            // apply new data
            qryEdEinsatzRegion["MLBezeichnung"] = edtBezeichnung.Text;
            qryEdEinsatzRegion["KGS"] = edtKGS.Text;
        }

        private void qryEdEinsatzRegion_BeforeDeleteQuestion(object sender, System.EventArgs e)
        {
            ...
            Int32 countUsage = Convert.ToInt32(DBUtil.ExecuteScalarSQLThrowingException(@"
                    ...
                    WHERE (',' + EinsatzorteRegionCodes + ',') LIKE '%,' + {0} + ',%'", Convert.ToString(qryEdEinsatzRegion["EdEinsatzRegionID"])));

            if (countUsage > 0)
            {
                // entry cannot be deleted because of usage
                KissMsg.ShowError("CtlAdEinsatzRegionVerwaltung", "CannotDeleteEntry", "Dieser Eintrag ist zurzeit zu mindestens eine Mitarbeiter-Verfügbarkeit zugewiesen und kann daher nicht gelöscht werden.");
        ...
        private void qryEdEinsatzRegion_BeforePost(object sender, System.EventArgs e)
        {
            // validate mustfields
            DBUtil.CheckNotNullField(edtBezeichnung, lblBezeichnung.Text);
            DBUtil.CheckNotNullField(edtKGS, lblKGS.Text);
        }

        ...
        */
		...
		private void qryBaWVCode_BeforeDeleteQuestion(object sender, System.EventArgs e)
		{
			...
			if (countExistingWEP > 0)
			{
				...
				KissMsg.ShowInfo("CtlBaPersonZUG", "CannotDeleteExistingWVEinzelposten", "Dieser Eintrag kann nicht mehr gelöscht werden, da bereits erzeugte Einzelposten davon abhängen. Stattdessen sollte der Status 'Verfallen' verwendet werden.");

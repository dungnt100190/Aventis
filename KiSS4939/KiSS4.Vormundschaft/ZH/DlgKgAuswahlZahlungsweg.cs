...
{
    public class DlgKgAuswahlZahlungsweg : KiSS4.Gui.KissDialog
    {
        #region Fields
        ...
        public DlgKgAuswahlZahlungsweg()
        {
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(DlgKgAuswahlZahlungsweg));
            ...
            this.cboLand.DataMember = "LandCode";
            ...
            this.kissTextEdit2.TabIndex = 608;
            ...
            this.Name = "DlgKgAuswahlZahlungsweg";
        ...
        {
            qryBaZahlungsweg.Fill(qryBaZahlungsweg.SelectStatement, beleg.KontoNummer.Replace('-', '%'));
        }

        public void SucheBaZahlungsweg(String SearchValue)
        {
            qryBaZahlungsweg.Fill(qryBaZahlungsweg.SelectStatement, "%" + SearchValue.Replace(' ', '%') + "%");
        }

...
namespace KiSS4.DesignerHost
{
    ...
    internal class MySelectionItem {

        // Public objects this selection deals with
        private Component                 component;      // the component that's selected
        private MySelectionService    selectionMgr;   // host interface
        private bool                      primary;        // is this the primary selection?

        ///  Constructor
        internal MySelectionItem(MySelectionService selectionMgr, Component component) {
        ...
        internal event EventHandler MySelectionItemDispose ;
        ...
        internal virtual void Dispose() {
            if (primary) {
                selectionMgr.SetPrimarySelection((MySelectionItem)null);
            }

            if (MySelectionItemDispose != null)
                MySelectionItemDispose(this, EventArgs.Empty);
        }
    }

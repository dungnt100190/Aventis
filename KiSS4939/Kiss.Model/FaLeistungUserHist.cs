...
namespace Kiss.Model
{
    ...
    public partial class FaLeistungUserHist: EntityBase<FaLeistungUserHist>, IObjectWithChangeTracker
    {
        ...
        public int FaLeistungUserHistID
        {
            ...
            set
            {
                if (_faLeistungUserHistID != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'FaLeistungUserHistID' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _faLeistungUserHistID = value;
                    OnPropertyChanged("FaLeistungUserHistID");
                }
            }
        }
        ...
        public byte[] FaLeistungUserHistTS
        {
            ...
            set
            {
                if (_faLeistungUserHistTS != value)
                {
                    ...
                    OnPropertyChanged("FaLeistungUserHistTS");
                }
            }
        }
        ...
        private void FixupFaLeistung(FaLeistung previousValue)
        {
            ...
            if (previousValue != null && previousValue.FaLeistungUserHist.Contains(this))
            {
                previousValue.FaLeistungUserHist.Remove(this);
            }
    
            if (FaLeistung != null)
            {
                if (!FaLeistung.FaLeistungUserHist.Contains(this))
                {
                    FaLeistung.FaLeistungUserHist.Add(this);
                }
        ...
        private void FixupXUser(XUser previousValue)
        {
            ...
            if (XUser != null)
            {
                if (!XUser.FaLeistungUserHist.Contains(this))
                {
                    XUser.FaLeistungUserHist.Add(this);
                }
    	...
    	public override bool Equals(object obj)
    	{
    		...
    		var entity = (FaLeistungUserHist)obj;
    		if (!_faLeistungUserHistID.Equals(entity.FaLeistungUserHistID) || _faLeistungUserHistID == 0)
    		{
    			return false;
    		}
        ...
        {
            return _faLeistungUserHistID.GetHashCode();
        }

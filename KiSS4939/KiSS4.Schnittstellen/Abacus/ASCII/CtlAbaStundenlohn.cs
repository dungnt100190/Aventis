    ...
    public partial class CtlAbaStundenlohn : CtlAbaASCIIBase
    {
        ...
        private void btnDatenExport_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                // --------------------------------------------------------------------------
                // set status
                SetStatusLabel("StatusExportSettingsVisum", "Einstellungen und Daten werden überprüft...");
                ...
                if (!KissMsg.ShowQuestion("CtlAbaStundenlohn", "ConfirmExportData", "Wollen Sie den Export für den Geschäftsbereich '{0}' und den Monat '{1}' jetzt durchführen?", 0, 0, true, edtGeschaeftsbereich.Text, edtDatumVon.Text))
                {
                    // logging
                ...
                if (hasAnyDataToExport)
                {
                    ...
                    if (!FolderExists(configRootDir))
                    {
                        ...
                        KissMsg.ShowInfo("CtlAbaStundenlohn", "ExportRootFolderNotFound", "Das Standardverzeichnis für den Datenexport wurde nicht gefunden, stattdessen wird 'Desktop' verwendet.");
                    }
                    ...
                    if (!FolderExists(exportPath))
                    {
                        ...
                        if (!CreateDirectory(exportPath))
                        {
                            ...
                            // show message to user
                            KissMsg.ShowInfo("CtlAbaStundenlohn", "ExportTargetFolderNotCreated", "Das gewünschte Zielverzeichnis für den Datenexport konnte nicht erstellt werden. Bitte überprüfen Sie das Verzeichnis und erstellen Sie den Zielordner gegebenenfalls von Hand.\r\n\r\nZiel: '{0}'", 0, 0, exportPath);
                        }
                    }
            ...
            finally
            {
                ...
                catch (Exception ex)
                {
                    ...
                    // error deleting file
                    KissMsg.ShowError("CtlAbaStundenlohn", "ErrorDeleteTempFile", "Fehler beim Löschen der erstellten temporären Datei.", ex);
                }
        ...
        private void btnDatenPruefen_Click(object sender, EventArgs e)
        {
                ...
                if (ValidateSettingsAndData())
                {
                    ...
                    if (CheckSindStundenErfasst())
                    {
                        KissMsg.ShowInfo("CtlAbaStundenlohn", "CheckSettingsVisumSuccessV2",
                                         "Sämtliche zu exportierende Daten wurden visiert und sind korrekt.");
                    }
                }
            }
            catch (Exception ex)
            {
                ...
                // set status
                SetStatusLabel("StatusCheckVisaErrorOccured", "Error: Überprüfen fehlgeschlagen!");
        ...
        private bool CheckSindStundenErfasst()
        {
            ...
            Diese Mitarbeiter müssen ihre Arbeitszeit erfassen bevor die Daten exportiert werden können", edtDatumVon.Text);
        ...
        /// - Geschäftsbereich muss gewählt sein.
        /// </summary>
        /// <returns></returns>
        ...
        private bool ValidateSettingsAndData()
        {
            ...
            try
            {
                ...
                if (qryValidiertNicht.Count > 0)
                {
                    ...
                    // show info
                    KissMsg.ShowInfo("CtlAbaStundenlohn", "InvalidDataFound", "Es wurden Daten gefunden, welche noch korrigiert werden müssen. Ein Export der Stunden ist nicht möglich.");
                    return false;
                }
            ...
            catch (Exception ex)
            {
                ...
                // set status
                SetStatusLabel("StatusValidateSetVisErrorOccured", "Error: Überprüfung fehlgeschlagen!");

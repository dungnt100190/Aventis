...
namespace Kiss.Infrastructure
{
    ...
    /// </summary>
    public class DragDropDataObject : System.Windows.Forms.IDataObject, System.Windows.IDataObject, IDragDropDataObject
    {
        /// <summary>
        ...
        /// </summary>
        private readonly IDataObject _comUnderlyingDataObject;
        ...
        /// </summary>
        private readonly System.Windows.Forms.IDataObject _oleUnderlyingWinFormsDataObject;

        /// <summary>
        /// Holds the <see cref="System.Windows.Forms.IDataObject"/> that this class is wrapping
        /// </summary>
        private readonly System.Windows.Forms.IDataObject _underlyingWinFormsDataObject;

        private readonly System.Windows.IDataObject _underlyingWpfDataObject;

        /// <summary>
        /// Initializes a new instance of the <see cref="DragDropDataObject"/> class.
        /// </summary>
        /// <param name="underlyingWinFormsDataObject">The underlying data object to wrap.</param>
        public DragDropDataObject(System.Windows.Forms.IDataObject underlyingWinFormsDataObject)
        {
            //get the underlying dataobject and its ComType IDataObject interface to it
            _underlyingWinFormsDataObject = underlyingWinFormsDataObject;
            _comUnderlyingDataObject = (IDataObject)_underlyingWinFormsDataObject;

            //get the internal ole dataobject and its GetDataFromHGLOBLAL so it can be called later
            var innerDataField = _underlyingWinFormsDataObject.GetType().GetField("innerData", BindingFlags.NonPublic | BindingFlags.Instance);
            if (innerDataField != null)
            {
                _oleUnderlyingWinFormsDataObject = (System.Windows.Forms.IDataObject)innerDataField.GetValue(_underlyingWinFormsDataObject);
                _getDataFromHgloblalMethod = _oleUnderlyingWinFormsDataObject.GetType().GetMethod("GetDataFromHGLOBLAL", BindingFlags.NonPublic | BindingFlags.Instance);
            }
        }

        public DragDropDataObject(System.Windows.IDataObject underlyingDataObject)
        {
            _underlyingWpfDataObject = underlyingDataObject;
            _comUnderlyingDataObject = (IDataObject)_underlyingWpfDataObject;
        }
        ...
        public object GetData(string format, bool autoConvert)
        {
            ...
            switch (format)
            {
                case "FileGroupDescriptor":
                    ...
                    try
                    {
                        ...
                        if (_underlyingWinFormsDataObject != null)
                        {
                            fileGroupDescriptorStream = (MemoryStream)_underlyingWinFormsDataObject.GetData("FileGroupDescriptor", autoConvert);
                        }
                        else
                        {
                            fileGroupDescriptorStream = (MemoryStream)_underlyingWpfDataObject.GetData("FileGroupDescriptor", autoConvert);
                        }
                ...
                case "FileGroupDescriptorW":
                    ...
                    try
                    {
                        ...
                        if (_underlyingWinFormsDataObject != null)
                        {
                            fileGroupDescriptorStream = (MemoryStream)_underlyingWinFormsDataObject.GetData("FileGroupDescriptorW");
                        }
                        else
                        {
                            fileGroupDescriptorStream = (MemoryStream)_underlyingWpfDataObject.GetData("FileGroupDescriptorW");
                        }
                        byte[] fileGroupDescriptorBytes = new byte[fileGroupDescriptorStream.Length];
                        fileGroupDescriptorStream.Read(fileGroupDescriptorBytes, 0, fileGroupDescriptorBytes.Length);
                        fileGroupDescriptorStream.Close();
            ...
            return _underlyingWinFormsDataObject != null
                ? _underlyingWinFormsDataObject.GetData(format, autoConvert)
                : _underlyingWpfDataObject.GetData(format, autoConvert);
        }
            ...
            switch (medium.tymed)
            {
                ...
                case TYMED.TYMED_HGLOBAL:
                    ...
                    if (_underlyingWinFormsDataObject != null)
                    {
                        return
                            (MemoryStream)
                                _getDataFromHgloblalMethod.Invoke(
                                    _oleUnderlyingWinFormsDataObject,
                                    new object[] { System.Windows.Forms.DataFormats.GetFormat(formatetc.cfFormat).Name, medium.unionmember });
                    }
                    return null;
            }
        ...
        {
            return _underlyingWinFormsDataObject != null
                ? _underlyingWinFormsDataObject.GetDataPresent(format)
                : _underlyingWpfDataObject.GetDataPresent(format);
        }
        ...
        {
            return _underlyingWinFormsDataObject != null
                ? _underlyingWinFormsDataObject.GetDataPresent(format, autoConvert)
                : _underlyingWpfDataObject.GetDataPresent(format, autoConvert);
        }
        ...
        {
            return _underlyingWinFormsDataObject != null ? _underlyingWinFormsDataObject.GetFormats() : _underlyingWpfDataObject.GetFormats();
        }
        ...
        {
            return _underlyingWinFormsDataObject != null ? _underlyingWinFormsDataObject.GetFormats(autoConvert) : _underlyingWpfDataObject.GetFormats(autoConvert);
        }
        ...
        public void SetData(object data)
        {
            if (_underlyingWinFormsDataObject != null)
            {
                _underlyingWinFormsDataObject.SetData(data);
            }
            else
            {
                _underlyingWpfDataObject.SetData(data);
            }
        }
        ...
        public void SetData(Type format, object data)
        {
            if (_underlyingWinFormsDataObject != null)
            {
                _underlyingWinFormsDataObject.SetData(format, data);
            }
            else
            {
                _underlyingWpfDataObject.SetData(format, data);
            }
        }
        ...
        public void SetData(string format, bool autoConvert, object data)
        {
            if (_underlyingWinFormsDataObject != null)
            {
                _underlyingWinFormsDataObject.SetData(format, autoConvert, data);
            }
            else
            {
                _underlyingWpfDataObject.SetData(format, data, autoConvert);
            }
        }
